...
@kernel(workgroup_size=(64,))
def mv_gateup_geglu_dq2_vec4_blk2(
    wid: Builtin.workgroup_id,
    lid: Builtin.local_invocation_id,
    gate_w: StorageBuffer[vec4[u32], "read"],
    up_w: StorageBuffer[vec4[u32], "read"],
    x: StorageBuffer[vec4[f32], "read"],
    gscale: StorageBuffer[f32, "read"],
    uscale: StorageBuffer[f32, "read"],
    y_out: StorageBuffer[f32, "read_write"],
    dims: StorageBuffer[u32, "read"],
    ...
    for j in range(li, n64, 64):
        ...
        xb: u32 = 16 * j
        xa00 = x[xb + 0]
        g0 += f32(i32(gv0.x & 3) - 2) * xa00.x
        u0 += f32(i32(uv0.x & 3) - 2) * xa00.x
        g1 += f32(i32(gv1.x & 3) - 2) * xa00.x
        u1 += f32(i32(uv1.x & 3) - 2) * xa00.x
        g0 += f32(i32((gv0.x >> 2) & 3) - 2) * xa00.y
        u0 += f32(i32((uv0.x >> 2) & 3) - 2) * xa00.y
        g1 += f32(i32((gv1.x >> 2) & 3) - 2) * xa00.y
        u1 += f32(i32((uv1.x >> 2) & 3) - 2) * xa00.y
        g0 += f32(i32((gv0.x >> 4) & 3) - 2) * xa00.z
        u0 += f32(i32((uv0.x >> 4) & 3) - 2) * xa00.z
        g1 += f32(i32((gv1.x >> 4) & 3) - 2) * xa00.z
        u1 += f32(i32((uv1.x >> 4) & 3) - 2) * xa00.z
        g0 += f32(i32((gv0.x >> 6) & 3) - 2) * xa00.w
        u0 += f32(i32((uv0.x >> 6) & 3) - 2) * xa00.w
        g1 += f32(i32((gv1.x >> 6) & 3) - 2) * xa00.w
        u1 += f32(i32((uv1.x >> 6) & 3) - 2) * xa00.w
        xa01 = x[xb + 1]
        g0 += f32(i32((gv0.x >> 8) & 3) - 2) * xa01.x
        u0 += f32(i32((uv0.x >> 8) & 3) - 2) * xa01.x
        g1 += f32(i32((gv1.x >> 8) & 3) - 2) * xa01.x
        u1 += f32(i32((uv1.x >> 8) & 3) - 2) * xa01.x
        g0 += f32(i32((gv0.x >> 10) & 3) - 2) * xa01.y
        u0 += f32(i32((uv0.x >> 10) & 3) - 2) * xa01.y
        g1 += f32(i32((gv1.x >> 10) & 3) - 2) * xa01.y
        u1 += f32(i32((uv1.x >> 10) & 3) - 2) * xa01.y
        g0 += f32(i32((gv0.x >> 12) & 3) - 2) * xa01.z
        u0 += f32(i32((uv0.x >> 12) & 3) - 2) * xa01.z
        g1 += f32(i32((gv1.x >> 12) & 3) - 2) * xa01.z
        u1 += f32(i32((uv1.x >> 12) & 3) - 2) * xa01.z
        g0 += f32(i32((gv0.x >> 14) & 3) - 2) * xa01.w
        u0 += f32(i32((uv0.x >> 14) & 3) - 2) * xa01.w
        g1 += f32(i32((gv1.x >> 14) & 3) - 2) * xa01.w
        u1 += f32(i32((uv1.x >> 14) & 3) - 2) * xa01.w
        xa02 = x[xb + 2]
        g0 += f32(i32((gv0.x >> 16) & 3) - 2) * xa02.x
        u0 += f32(i32((uv0.x >> 16) & 3) - 2) * xa02.x
        g1 += f32(i32((gv1.x >> 16) & 3) - 2) * xa02.x
        u1 += f32(i32((uv1.x >> 16) & 3) - 2) * xa02.x
        g0 += f32(i32((gv0.x >> 18) & 3) - 2) * xa02.y
        u0 += f32(i32((uv0.x >> 18) & 3) - 2) * xa02.y
        g1 += f32(i32((gv1.x >> 18) & 3) - 2) * xa02.y
        u1 += f32(i32((uv1.x >> 18) & 3) - 2) * xa02.y
        g0 += f32(i32((gv0.x >> 20) & 3) - 2) * xa02.z
        u0 += f32(i32((uv0.x >> 20) & 3) - 2) * xa02.z
        g1 += f32(i32((gv1.x >> 20) & 3) - 2) * xa02.z
        u1 += f32(i32((uv1.x >> 20) & 3) - 2) * xa02.z
        g0 += f32(i32((gv0.x >> 22) & 3) - 2) * xa02.w
        u0 += f32(i32((uv0.x >> 22) & 3) - 2) * xa02.w
        g1 += f32(i32((gv1.x >> 22) & 3) - 2) * xa02.w
        u1 += f32(i32((uv1.x >> 22) & 3) - 2) * xa02.w
        xa03 = x[xb + 3]
        g0 += f32(i32((gv0.x >> 24) & 3) - 2) * xa03.x
        u0 += f32(i32((uv0.x >> 24) & 3) - 2) * xa03.x
        g1 += f32(i32((gv1.x >> 24) & 3) - 2) * xa03.x
        u1 += f32(i32((uv1.x >> 24) & 3) - 2) * xa03.x
        g0 += f32(i32((gv0.x >> 26) & 3) - 2) * xa03.y
        u0 += f32(i32((uv0.x >> 26) & 3) - 2) * xa03.y
        g1 += f32(i32((gv1.x >> 26) & 3) - 2) * xa03.y
        u1 += f32(i32((uv1.x >> 26) & 3) - 2) * xa03.y
        g0 += f32(i32((gv0.x >> 28) & 3) - 2) * xa03.z
        u0 += f32(i32((uv0.x >> 28) & 3) - 2) * xa03.z
        g1 += f32(i32((gv1.x >> 28) & 3) - 2) * xa03.z
        u1 += f32(i32((uv1.x >> 28) & 3) - 2) * xa03.z
        g0 += f32(i32((gv0.x >> 30) & 3) - 2) * xa03.w
        u0 += f32(i32((uv0.x >> 30) & 3) - 2) * xa03.w
        g1 += f32(i32((gv1.x >> 30) & 3) - 2) * xa03.w
        u1 += f32(i32((uv1.x >> 30) & 3) - 2) * xa03.w
        xa10 = x[xb + 4]
        g0 += f32(i32(gv0.y & 3) - 2) * xa10.x
        u0 += f32(i32(uv0.y & 3) - 2) * xa10.x
        g1 += f32(i32(gv1.y & 3) - 2) * xa10.x
        u1 += f32(i32(uv1.y & 3) - 2) * xa10.x
        g0 += f32(i32((gv0.y >> 2) & 3) - 2) * xa10.y
        u0 += f32(i32((uv0.y >> 2) & 3) - 2) * xa10.y
        g1 += f32(i32((gv1.y >> 2) & 3) - 2) * xa10.y
        u1 += f32(i32((uv1.y >> 2) & 3) - 2) * xa10.y
        g0 += f32(i32((gv0.y >> 4) & 3) - 2) * xa10.z
        u0 += f32(i32((uv0.y >> 4) & 3) - 2) * xa10.z
        g1 += f32(i32((gv1.y >> 4) & 3) - 2) * xa10.z
        u1 += f32(i32((uv1.y >> 4) & 3) - 2) * xa10.z
        g0 += f32(i32((gv0.y >> 6) & 3) - 2) * xa10.w
        u0 += f32(i32((uv0.y >> 6) & 3) - 2) * xa10.w
        g1 += f32(i32((gv1.y >> 6) & 3) - 2) * xa10.w
        u1 += f32(i32((uv1.y >> 6) & 3) - 2) * xa10.w
        xa11 = x[xb + 5]
        g0 += f32(i32((gv0.y >> 8) & 3) - 2) * xa11.x
        u0 += f32(i32((uv0.y >> 8) & 3) - 2) * xa11.x
        g1 += f32(i32((gv1.y >> 8) & 3) - 2) * xa11.x
        u1 += f32(i32((uv1.y >> 8) & 3) - 2) * xa11.x
        g0 += f32(i32((gv0.y >> 10) & 3) - 2) * xa11.y
        u0 += f32(i32((uv0.y >> 10) & 3) - 2) * xa11.y
        g1 += f32(i32((gv1.y >> 10) & 3) - 2) * xa11.y
        u1 += f32(i32((uv1.y >> 10) & 3) - 2) * xa11.y
        g0 += f32(i32((gv0.y >> 12) & 3) - 2) * xa11.z
        u0 += f32(i32((uv0.y >> 12) & 3) - 2) * xa11.z
        g1 += f32(i32((gv1.y >> 12) & 3) - 2) * xa11.z
        u1 += f32(i32((uv1.y >> 12) & 3) - 2) * xa11.z
        g0 += f32(i32((gv0.y >> 14) & 3) - 2) * xa11.w
        u0 += f32(i32((uv0.y >> 14) & 3) - 2) * xa11.w
        g1 += f32(i32((gv1.y >> 14) & 3) - 2) * xa11.w
        u1 += f32(i32((uv1.y >> 14) & 3) - 2) * xa11.w
        xa12 = x[xb + 6]
        g0 += f32(i32((gv0.y >> 16) & 3) - 2) * xa12.x
        u0 += f32(i32((uv0.y >> 16) & 3) - 2) * xa12.x
        g1 += f32(i32((gv1.y >> 16) & 3) - 2) * xa12.x
        u1 += f32(i32((uv1.y >> 16) & 3) - 2) * xa12.x
        g0 += f32(i32((gv0.y >> 18) & 3) - 2) * xa12.y
        u0 += f32(i32((uv0.y >> 18) & 3) - 2) * xa12.y
        g1 += f32(i32((gv1.y >> 18) & 3) - 2) * xa12.y
        u1 += f32(i32((uv1.y >> 18) & 3) - 2) * xa12.y
        g0 += f32(i32((gv0.y >> 20) & 3) - 2) * xa12.z
        u0 += f32(i32((uv0.y >> 20) & 3) - 2) * xa12.z
        g1 += f32(i32((gv1.y >> 20) & 3) - 2) * xa12.z
        u1 += f32(i32((uv1.y >> 20) & 3) - 2) * xa12.z
        g0 += f32(i32((gv0.y >> 22) & 3) - 2) * xa12.w
        u0 += f32(i32((uv0.y >> 22) & 3) - 2) * xa12.w
        g1 += f32(i32((gv1.y >> 22) & 3) - 2) * xa12.w
        u1 += f32(i32((uv1.y >> 22) & 3) - 2) * xa12.w
        xa13 = x[xb + 7]
        g0 += f32(i32((gv0.y >> 24) & 3) - 2) * xa13.x
        u0 += f32(i32((uv0.y >> 24) & 3) - 2) * xa13.x
        g1 += f32(i32((gv1.y >> 24) & 3) - 2) * xa13.x
        u1 += f32(i32((uv1.y >> 24) & 3) - 2) * xa13.x
        g0 += f32(i32((gv0.y >> 26) & 3) - 2) * xa13.y
        u0 += f32(i32((uv0.y >> 26) & 3) - 2) * xa13.y
        g1 += f32(i32((gv1.y >> 26) & 3) - 2) * xa13.y
        u1 += f32(i32((uv1.y >> 26) & 3) - 2) * xa13.y
        g0 += f32(i32((gv0.y >> 28) & 3) - 2) * xa13.z
        u0 += f32(i32((uv0.y >> 28) & 3) - 2) * xa13.z
        g1 += f32(i32((gv1.y >> 28) & 3) - 2) * xa13.z
        u1 += f32(i32((uv1.y >> 28) & 3) - 2) * xa13.z
        g0 += f32(i32((gv0.y >> 30) & 3) - 2) * xa13.w
        u0 += f32(i32((uv0.y >> 30) & 3) - 2) * xa13.w
        g1 += f32(i32((gv1.y >> 30) & 3) - 2) * xa13.w
        u1 += f32(i32((uv1.y >> 30) & 3) - 2) * xa13.w
        xa20 = x[xb + 8]
        g0 += f32(i32(gv0.z & 3) - 2) * xa20.x
        u0 += f32(i32(uv0.z & 3) - 2) * xa20.x
        g1 += f32(i32(gv1.z & 3) - 2) * xa20.x
        u1 += f32(i32(uv1.z & 3) - 2) * xa20.x
        g0 += f32(i32((gv0.z >> 2) & 3) - 2) * xa20.y
        u0 += f32(i32((uv0.z >> 2) & 3) - 2) * xa20.y
        g1 += f32(i32((gv1.z >> 2) & 3) - 2) * xa20.y
        u1 += f32(i32((uv1.z >> 2) & 3) - 2) * xa20.y
        g0 += f32(i32((gv0.z >> 4) & 3) - 2) * xa20.z
        u0 += f32(i32((uv0.z >> 4) & 3) - 2) * xa20.z
        g1 += f32(i32((gv1.z >> 4) & 3) - 2) * xa20.z
        u1 += f32(i32((uv1.z >> 4) & 3) - 2) * xa20.z
        g0 += f32(i32((gv0.z >> 6) & 3) - 2) * xa20.w
        u0 += f32(i32((uv0.z >> 6) & 3) - 2) * xa20.w
        g1 += f32(i32((gv1.z >> 6) & 3) - 2) * xa20.w
        u1 += f32(i32((uv1.z >> 6) & 3) - 2) * xa20.w
        xa21 = x[xb + 9]
        g0 += f32(i32((gv0.z >> 8) & 3) - 2) * xa21.x
        u0 += f32(i32((uv0.z >> 8) & 3) - 2) * xa21.x
        g1 += f32(i32((gv1.z >> 8) & 3) - 2) * xa21.x
        u1 += f32(i32((uv1.z >> 8) & 3) - 2) * xa21.x
        g0 += f32(i32((gv0.z >> 10) & 3) - 2) * xa21.y
        u0 += f32(i32((uv0.z >> 10) & 3) - 2) * xa21.y
        g1 += f32(i32((gv1.z >> 10) & 3) - 2) * xa21.y
        u1 += f32(i32((uv1.z >> 10) & 3) - 2) * xa21.y
        g0 += f32(i32((gv0.z >> 12) & 3) - 2) * xa21.z
        u0 += f32(i32((uv0.z >> 12) & 3) - 2) * xa21.z
        g1 += f32(i32((gv1.z >> 12) & 3) - 2) * xa21.z
        u1 += f32(i32((uv1.z >> 12) & 3) - 2) * xa21.z
        g0 += f32(i32((gv0.z >> 14) & 3) - 2) * xa21.w
        u0 += f32(i32((uv0.z >> 14) & 3) - 2) * xa21.w
        g1 += f32(i32((gv1.z >> 14) & 3) - 2) * xa21.w
        u1 += f32(i32((uv1.z >> 14) & 3) - 2) * xa21.w
        xa22 = x[xb + 10]
        g0 += f32(i32((gv0.z >> 16) & 3) - 2) * xa22.x
        u0 += f32(i32((uv0.z >> 16) & 3) - 2) * xa22.x
        g1 += f32(i32((gv1.z >> 16) & 3) - 2) * xa22.x
        u1 += f32(i32((uv1.z >> 16) & 3) - 2) * xa22.x
        g0 += f32(i32((gv0.z >> 18) & 3) - 2) * xa22.y
        u0 += f32(i32((uv0.z >> 18) & 3) - 2) * xa22.y
        g1 += f32(i32((gv1.z >> 18) & 3) - 2) * xa22.y
        u1 += f32(i32((uv1.z >> 18) & 3) - 2) * xa22.y
        g0 += f32(i32((gv0.z >> 20) & 3) - 2) * xa22.z
        u0 += f32(i32((uv0.z >> 20) & 3) - 2) * xa22.z
        g1 += f32(i32((gv1.z >> 20) & 3) - 2) * xa22.z
        u1 += f32(i32((uv1.z >> 20) & 3) - 2) * xa22.z
        g0 += f32(i32((gv0.z >> 22) & 3) - 2) * xa22.w
        u0 += f32(i32((uv0.z >> 22) & 3) - 2) * xa22.w
        g1 += f32(i32((gv1.z >> 22) & 3) - 2) * xa22.w
        u1 += f32(i32((uv1.z >> 22) & 3) - 2) * xa22.w
        xa23 = x[xb + 11]
        g0 += f32(i32((gv0.z >> 24) & 3) - 2) * xa23.x
        u0 += f32(i32((uv0.z >> 24) & 3) - 2) * xa23.x
        g1 += f32(i32((gv1.z >> 24) & 3) - 2) * xa23.x
        u1 += f32(i32((uv1.z >> 24) & 3) - 2) * xa23.x
        g0 += f32(i32((gv0.z >> 26) & 3) - 2) * xa23.y
        u0 += f32(i32((uv0.z >> 26) & 3) - 2) * xa23.y
        g1 += f32(i32((gv1.z >> 26) & 3) - 2) * xa23.y
        u1 += f32(i32((uv1.z >> 26) & 3) - 2) * xa23.y
        g0 += f32(i32((gv0.z >> 28) & 3) - 2) * xa23.z
        u0 += f32(i32((uv0.z >> 28) & 3) - 2) * xa23.z
        g1 += f32(i32((gv1.z >> 28) & 3) - 2) * xa23.z
        u1 += f32(i32((uv1.z >> 28) & 3) - 2) * xa23.z
        g0 += f32(i32((gv0.z >> 30) & 3) - 2) * xa23.w
        u0 += f32(i32((uv0.z >> 30) & 3) - 2) * xa23.w
        g1 += f32(i32((gv1.z >> 30) & 3) - 2) * xa23.w
        u1 += f32(i32((uv1.z >> 30) & 3) - 2) * xa23.w
        xa30 = x[xb + 12]
        g0 += f32(i32(gv0.w & 3) - 2) * xa30.x
        u0 += f32(i32(uv0.w & 3) - 2) * xa30.x
        g1 += f32(i32(gv1.w & 3) - 2) * xa30.x
        u1 += f32(i32(uv1.w & 3) - 2) * xa30.x
        g0 += f32(i32((gv0.w >> 2) & 3) - 2) * xa30.y
        u0 += f32(i32((uv0.w >> 2) & 3) - 2) * xa30.y
        g1 += f32(i32((gv1.w >> 2) & 3) - 2) * xa30.y
        u1 += f32(i32((uv1.w >> 2) & 3) - 2) * xa30.y
        g0 += f32(i32((gv0.w >> 4) & 3) - 2) * xa30.z
        u0 += f32(i32((uv0.w >> 4) & 3) - 2) * xa30.z
        g1 += f32(i32((gv1.w >> 4) & 3) - 2) * xa30.z
        u1 += f32(i32((uv1.w >> 4) & 3) - 2) * xa30.z
        g0 += f32(i32((gv0.w >> 6) & 3) - 2) * xa30.w
        u0 += f32(i32((uv0.w >> 6) & 3) - 2) * xa30.w
        g1 += f32(i32((gv1.w >> 6) & 3) - 2) * xa30.w
        u1 += f32(i32((uv1.w >> 6) & 3) - 2) * xa30.w
        xa31 = x[xb + 13]
        g0 += f32(i32((gv0.w >> 8) & 3) - 2) * xa31.x
        u0 += f32(i32((uv0.w >> 8) & 3) - 2) * xa31.x
        g1 += f32(i32((gv1.w >> 8) & 3) - 2) * xa31.x
        u1 += f32(i32((uv1.w >> 8) & 3) - 2) * xa31.x
        g0 += f32(i32((gv0.w >> 10) & 3) - 2) * xa31.y
        u0 += f32(i32((uv0.w >> 10) & 3) - 2) * xa31.y
        g1 += f32(i32((gv1.w >> 10) & 3) - 2) * xa31.y
        u1 += f32(i32((uv1.w >> 10) & 3) - 2) * xa31.y
        g0 += f32(i32((gv0.w >> 12) & 3) - 2) * xa31.z
        u0 += f32(i32((uv0.w >> 12) & 3) - 2) * xa31.z
        g1 += f32(i32((gv1.w >> 12) & 3) - 2) * xa31.z
        u1 += f32(i32((uv1.w >> 12) & 3) - 2) * xa31.z
        g0 += f32(i32((gv0.w >> 14) & 3) - 2) * xa31.w
        u0 += f32(i32((uv0.w >> 14) & 3) - 2) * xa31.w
        g1 += f32(i32((gv1.w >> 14) & 3) - 2) * xa31.w
        u1 += f32(i32((uv1.w >> 14) & 3) - 2) * xa31.w
        xa32 = x[xb + 14]
        g0 += f32(i32((gv0.w >> 16) & 3) - 2) * xa32.x
        u0 += f32(i32((uv0.w >> 16) & 3) - 2) * xa32.x
        g1 += f32(i32((gv1.w >> 16) & 3) - 2) * xa32.x
        u1 += f32(i32((uv1.w >> 16) & 3) - 2) * xa32.x
        g0 += f32(i32((gv0.w >> 18) & 3) - 2) * xa32.y
        u0 += f32(i32((uv0.w >> 18) & 3) - 2) * xa32.y
        g1 += f32(i32((gv1.w >> 18) & 3) - 2) * xa32.y
        u1 += f32(i32((uv1.w >> 18) & 3) - 2) * xa32.y
        g0 += f32(i32((gv0.w >> 20) & 3) - 2) * xa32.z
        u0 += f32(i32((uv0.w >> 20) & 3) - 2) * xa32.z
        g1 += f32(i32((gv1.w >> 20) & 3) - 2) * xa32.z
        u1 += f32(i32((uv1.w >> 20) & 3) - 2) * xa32.z
        g0 += f32(i32((gv0.w >> 22) & 3) - 2) * xa32.w
        u0 += f32(i32((uv0.w >> 22) & 3) - 2) * xa32.w
        g1 += f32(i32((gv1.w >> 22) & 3) - 2) * xa32.w
        u1 += f32(i32((uv1.w >> 22) & 3) - 2) * xa32.w
        xa33 = x[xb + 15]
        g0 += f32(i32((gv0.w >> 24) & 3) - 2) * xa33.x
        u0 += f32(i32((uv0.w >> 24) & 3) - 2) * xa33.x
        g1 += f32(i32((gv1.w >> 24) & 3) - 2) * xa33.x
        u1 += f32(i32((uv1.w >> 24) & 3) - 2) * xa33.x
        g0 += f32(i32((gv0.w >> 26) & 3) - 2) * xa33.y
        u0 += f32(i32((uv0.w >> 26) & 3) - 2) * xa33.y
        g1 += f32(i32((gv1.w >> 26) & 3) - 2) * xa33.y
        u1 += f32(i32((uv1.w >> 26) & 3) - 2) * xa33.y
        g0 += f32(i32((gv0.w >> 28) & 3) - 2) * xa33.z
        u0 += f32(i32((uv0.w >> 28) & 3) - 2) * xa33.z
        g1 += f32(i32((gv1.w >> 28) & 3) - 2) * xa33.z
        u1 += f32(i32((uv1.w >> 28) & 3) - 2) * xa33.z
        g0 += f32(i32((gv0.w >> 30) & 3) - 2) * xa33.w
        u0 += f32(i32((uv0.w >> 30) & 3) - 2) * xa33.w
        g1 += f32(i32((gv1.w >> 30) & 3) - 2) * xa33.w
        u1 += f32(i32((uv1.w >> 30) & 3) - 2) * xa33.w
    pg0[li] = g0
    pu0[li] = u0
    pg1[li] = g1
    pu1[li] = u1
...
def matvec_dq4_vec4(
    wid: Builtin.workgroup_id,
    lid: Builtin.local_invocation_id,
    w: StorageBuffer[vec4[u32], "read"],   # [n_out, n_in/32] (vec4<u32>=32 int4)
    x: StorageBuffer[vec4[f32], "read"],   # [n_in/4]
    scale: StorageBuffer[f32, "read"],
    y_out: StorageBuffer[f32, "read_write"],
    dims: StorageBuffer[u32, "read"],      # [n_out, n_in] (n_in % 32 == 0)
    partial: WorkgroupArray[f32, 64],
):
    r: u32 = wid.x
    li: u32 = lid.x
    ...
    acc: f32 = 0.0
    if r < n_out:
        for j in range(li, n32, 64):
            wv = w[r * n32 + j]
            xb: u32 = 8 * j
            xa00 = x[xb + 0]
            acc += f32(i32(wv.x & 15) - 8) * xa00.x
            acc += f32(i32((wv.x >> 4) & 15) - 8) * xa00.y
            acc += f32(i32((wv.x >> 8) & 15) - 8) * xa00.z
            acc += f32(i32((wv.x >> 12) & 15) - 8) * xa00.w
            xa01 = x[xb + 1]
            acc += f32(i32((wv.x >> 16) & 15) - 8) * xa01.x
            acc += f32(i32((wv.x >> 20) & 15) - 8) * xa01.y
            acc += f32(i32((wv.x >> 24) & 15) - 8) * xa01.z
            acc += f32(i32((wv.x >> 28) & 15) - 8) * xa01.w
            xa10 = x[xb + 2]
            acc += f32(i32(wv.y & 15) - 8) * xa10.x
            acc += f32(i32((wv.y >> 4) & 15) - 8) * xa10.y
            acc += f32(i32((wv.y >> 8) & 15) - 8) * xa10.z
            acc += f32(i32((wv.y >> 12) & 15) - 8) * xa10.w
            xa11 = x[xb + 3]
            acc += f32(i32((wv.y >> 16) & 15) - 8) * xa11.x
            acc += f32(i32((wv.y >> 20) & 15) - 8) * xa11.y
            acc += f32(i32((wv.y >> 24) & 15) - 8) * xa11.z
            acc += f32(i32((wv.y >> 28) & 15) - 8) * xa11.w
            xa20 = x[xb + 4]
            acc += f32(i32(wv.z & 15) - 8) * xa20.x
            acc += f32(i32((wv.z >> 4) & 15) - 8) * xa20.y
            acc += f32(i32((wv.z >> 8) & 15) - 8) * xa20.z
            acc += f32(i32((wv.z >> 12) & 15) - 8) * xa20.w
            xa21 = x[xb + 5]
            acc += f32(i32((wv.z >> 16) & 15) - 8) * xa21.x
            acc += f32(i32((wv.z >> 20) & 15) - 8) * xa21.y
            acc += f32(i32((wv.z >> 24) & 15) - 8) * xa21.z
            acc += f32(i32((wv.z >> 28) & 15) - 8) * xa21.w
            xa30 = x[xb + 6]
            acc += f32(i32(wv.w & 15) - 8) * xa30.x
            acc += f32(i32((wv.w >> 4) & 15) - 8) * xa30.y
            acc += f32(i32((wv.w >> 8) & 15) - 8) * xa30.z
            acc += f32(i32((wv.w >> 12) & 15) - 8) * xa30.w
            xa31 = x[xb + 7]
            acc += f32(i32((wv.w >> 16) & 15) - 8) * xa31.x
            acc += f32(i32((wv.w >> 20) & 15) - 8) * xa31.y
            acc += f32(i32((wv.w >> 24) & 15) - 8) * xa31.z
            acc += f32(i32((wv.w >> 28) & 15) - 8) * xa31.w
    partial[li] = acc
    barrier()
    s: u32 = 32
    while s > 0:
...
@kernel(workgroup_size=(32,))
def mv_gateup_geglu_dq2_combo4(
    wid: Builtin.workgroup_id,
    lid: Builtin.local_invocation_id,
    gate_w: StorageBuffer[vec4[u32], "read"],
    up_w: StorageBuffer[vec4[u32], "read"],
    ...
    # 4 rows/wg, 32 threads (1 subgroup, 1 vec4 load/thread), subgroupAdd, no barriers.
    r0: u32 = 4 * wid.x + 0
    r1: u32 = 4 * wid.x + 1
    r2: u32 = 4 * wid.x + 2
    r3: u32 = 4 * wid.x + 3
    ...
    u3: f32 = 0.0
    if li < n64:
        gv0 = gate_w[r0 * n64 + li]
        uv0 = up_w[r0 * n64 + li]
        gv1 = gate_w[r1 * n64 + li]
        uv1 = up_w[r1 * n64 + li]
        gv2 = gate_w[r2 * n64 + li]
        uv2 = up_w[r2 * n64 + li]
        gv3 = gate_w[r3 * n64 + li]
        uv3 = up_w[r3 * n64 + li]
        xb: u32 = 16 * li
        xa00 = x[xb + 0]
        g0 += f32(i32(gv0.x & 3) - 2) * xa00.x
        ...
        g1 += f32(i32(gv1.x & 3) - 2) * xa00.x
        u1 += f32(i32(uv1.x & 3) - 2) * xa00.x
        g2 += f32(i32(gv2.x & 3) - 2) * xa00.x
        u2 += f32(i32(uv2.x & 3) - 2) * xa00.x
        g3 += f32(i32(gv3.x & 3) - 2) * xa00.x
        u3 += f32(i32(uv3.x & 3) - 2) * xa00.x
        g0 += f32(i32((gv0.x >> 2) & 3) - 2) * xa00.y
        u0 += f32(i32((uv0.x >> 2) & 3) - 2) * xa00.y
        g1 += f32(i32((gv1.x >> 2) & 3) - 2) * xa00.y
        u1 += f32(i32((uv1.x >> 2) & 3) - 2) * xa00.y
        g2 += f32(i32((gv2.x >> 2) & 3) - 2) * xa00.y
        u2 += f32(i32((uv2.x >> 2) & 3) - 2) * xa00.y
        g3 += f32(i32((gv3.x >> 2) & 3) - 2) * xa00.y
        u3 += f32(i32((uv3.x >> 2) & 3) - 2) * xa00.y
        g0 += f32(i32((gv0.x >> 4) & 3) - 2) * xa00.z
        u0 += f32(i32((uv0.x >> 4) & 3) - 2) * xa00.z
        g1 += f32(i32((gv1.x >> 4) & 3) - 2) * xa00.z
        u1 += f32(i32((uv1.x >> 4) & 3) - 2) * xa00.z
        g2 += f32(i32((gv2.x >> 4) & 3) - 2) * xa00.z
        u2 += f32(i32((uv2.x >> 4) & 3) - 2) * xa00.z
        g3 += f32(i32((gv3.x >> 4) & 3) - 2) * xa00.z
        u3 += f32(i32((uv3.x >> 4) & 3) - 2) * xa00.z
        g0 += f32(i32((gv0.x >> 6) & 3) - 2) * xa00.w
        u0 += f32(i32((uv0.x >> 6) & 3) - 2) * xa00.w
        g1 += f32(i32((gv1.x >> 6) & 3) - 2) * xa00.w
        u1 += f32(i32((uv1.x >> 6) & 3) - 2) * xa00.w
        g2 += f32(i32((gv2.x >> 6) & 3) - 2) * xa00.w
        u2 += f32(i32((uv2.x >> 6) & 3) - 2) * xa00.w
        g3 += f32(i32((gv3.x >> 6) & 3) - 2) * xa00.w
        u3 += f32(i32((uv3.x >> 6) & 3) - 2) * xa00.w
        xa01 = x[xb + 1]
        g0 += f32(i32((gv0.x >> 8) & 3) - 2) * xa01.x
        u0 += f32(i32((uv0.x >> 8) & 3) - 2) * xa01.x
        g1 += f32(i32((gv1.x >> 8) & 3) - 2) * xa01.x
        u1 += f32(i32((uv1.x >> 8) & 3) - 2) * xa01.x
        g2 += f32(i32((gv2.x >> 8) & 3) - 2) * xa01.x
        u2 += f32(i32((uv2.x >> 8) & 3) - 2) * xa01.x
        g3 += f32(i32((gv3.x >> 8) & 3) - 2) * xa01.x
        u3 += f32(i32((uv3.x >> 8) & 3) - 2) * xa01.x
        g0 += f32(i32((gv0.x >> 10) & 3) - 2) * xa01.y
        u0 += f32(i32((uv0.x >> 10) & 3) - 2) * xa01.y
        g1 += f32(i32((gv1.x >> 10) & 3) - 2) * xa01.y
        u1 += f32(i32((uv1.x >> 10) & 3) - 2) * xa01.y
        g2 += f32(i32((gv2.x >> 10) & 3) - 2) * xa01.y
        u2 += f32(i32((uv2.x >> 10) & 3) - 2) * xa01.y
        g3 += f32(i32((gv3.x >> 10) & 3) - 2) * xa01.y
        u3 += f32(i32((uv3.x >> 10) & 3) - 2) * xa01.y
        g0 += f32(i32((gv0.x >> 12) & 3) - 2) * xa01.z
        u0 += f32(i32((uv0.x >> 12) & 3) - 2) * xa01.z
        g1 += f32(i32((gv1.x >> 12) & 3) - 2) * xa01.z
        u1 += f32(i32((uv1.x >> 12) & 3) - 2) * xa01.z
        g2 += f32(i32((gv2.x >> 12) & 3) - 2) * xa01.z
        u2 += f32(i32((uv2.x >> 12) & 3) - 2) * xa01.z
        g3 += f32(i32((gv3.x >> 12) & 3) - 2) * xa01.z
        u3 += f32(i32((uv3.x >> 12) & 3) - 2) * xa01.z
        g0 += f32(i32((gv0.x >> 14) & 3) - 2) * xa01.w
        u0 += f32(i32((uv0.x >> 14) & 3) - 2) * xa01.w
        g1 += f32(i32((gv1.x >> 14) & 3) - 2) * xa01.w
        u1 += f32(i32((uv1.x >> 14) & 3) - 2) * xa01.w
        g2 += f32(i32((gv2.x >> 14) & 3) - 2) * xa01.w
        u2 += f32(i32((uv2.x >> 14) & 3) - 2) * xa01.w
        g3 += f32(i32((gv3.x >> 14) & 3) - 2) * xa01.w
        u3 += f32(i32((uv3.x >> 14) & 3) - 2) * xa01.w
        xa02 = x[xb + 2]
        g0 += f32(i32((gv0.x >> 16) & 3) - 2) * xa02.x
        u0 += f32(i32((uv0.x >> 16) & 3) - 2) * xa02.x
        g1 += f32(i32((gv1.x >> 16) & 3) - 2) * xa02.x
        u1 += f32(i32((uv1.x >> 16) & 3) - 2) * xa02.x
        g2 += f32(i32((gv2.x >> 16) & 3) - 2) * xa02.x
        u2 += f32(i32((uv2.x >> 16) & 3) - 2) * xa02.x
        g3 += f32(i32((gv3.x >> 16) & 3) - 2) * xa02.x
        u3 += f32(i32((uv3.x >> 16) & 3) - 2) * xa02.x
        g0 += f32(i32((gv0.x >> 18) & 3) - 2) * xa02.y
        u0 += f32(i32((uv0.x >> 18) & 3) - 2) * xa02.y
        g1 += f32(i32((gv1.x >> 18) & 3) - 2) * xa02.y
        u1 += f32(i32((uv1.x >> 18) & 3) - 2) * xa02.y
        g2 += f32(i32((gv2.x >> 18) & 3) - 2) * xa02.y
        u2 += f32(i32((uv2.x >> 18) & 3) - 2) * xa02.y
        g3 += f32(i32((gv3.x >> 18) & 3) - 2) * xa02.y
        u3 += f32(i32((uv3.x >> 18) & 3) - 2) * xa02.y
        g0 += f32(i32((gv0.x >> 20) & 3) - 2) * xa02.z
        u0 += f32(i32((uv0.x >> 20) & 3) - 2) * xa02.z
        g1 += f32(i32((gv1.x >> 20) & 3) - 2) * xa02.z
        u1 += f32(i32((uv1.x >> 20) & 3) - 2) * xa02.z
        g2 += f32(i32((gv2.x >> 20) & 3) - 2) * xa02.z
        u2 += f32(i32((uv2.x >> 20) & 3) - 2) * xa02.z
        g3 += f32(i32((gv3.x >> 20) & 3) - 2) * xa02.z
        u3 += f32(i32((uv3.x >> 20) & 3) - 2) * xa02.z
        g0 += f32(i32((gv0.x >> 22) & 3) - 2) * xa02.w
        u0 += f32(i32((uv0.x >> 22) & 3) - 2) * xa02.w
        g1 += f32(i32((gv1.x >> 22) & 3) - 2) * xa02.w
        u1 += f32(i32((uv1.x >> 22) & 3) - 2) * xa02.w
        g2 += f32(i32((gv2.x >> 22) & 3) - 2) * xa02.w
        u2 += f32(i32((uv2.x >> 22) & 3) - 2) * xa02.w
        g3 += f32(i32((gv3.x >> 22) & 3) - 2) * xa02.w
        u3 += f32(i32((uv3.x >> 22) & 3) - 2) * xa02.w
        xa03 = x[xb + 3]
        g0 += f32(i32((gv0.x >> 24) & 3) - 2) * xa03.x
        u0 += f32(i32((uv0.x >> 24) & 3) - 2) * xa03.x
        g1 += f32(i32((gv1.x >> 24) & 3) - 2) * xa03.x
        u1 += f32(i32((uv1.x >> 24) & 3) - 2) * xa03.x
        g2 += f32(i32((gv2.x >> 24) & 3) - 2) * xa03.x
        u2 += f32(i32((uv2.x >> 24) & 3) - 2) * xa03.x
        g3 += f32(i32((gv3.x >> 24) & 3) - 2) * xa03.x
        u3 += f32(i32((uv3.x >> 24) & 3) - 2) * xa03.x
        g0 += f32(i32((gv0.x >> 26) & 3) - 2) * xa03.y
        u0 += f32(i32((uv0.x >> 26) & 3) - 2) * xa03.y
        g1 += f32(i32((gv1.x >> 26) & 3) - 2) * xa03.y
        u1 += f32(i32((uv1.x >> 26) & 3) - 2) * xa03.y
        g2 += f32(i32((gv2.x >> 26) & 3) - 2) * xa03.y
        u2 += f32(i32((uv2.x >> 26) & 3) - 2) * xa03.y
        g3 += f32(i32((gv3.x >> 26) & 3) - 2) * xa03.y
        u3 += f32(i32((uv3.x >> 26) & 3) - 2) * xa03.y
        g0 += f32(i32((gv0.x >> 28) & 3) - 2) * xa03.z
        u0 += f32(i32((uv0.x >> 28) & 3) - 2) * xa03.z
        g1 += f32(i32((gv1.x >> 28) & 3) - 2) * xa03.z
        u1 += f32(i32((uv1.x >> 28) & 3) - 2) * xa03.z
        g2 += f32(i32((gv2.x >> 28) & 3) - 2) * xa03.z
        u2 += f32(i32((uv2.x >> 28) & 3) - 2) * xa03.z
        g3 += f32(i32((gv3.x >> 28) & 3) - 2) * xa03.z
        u3 += f32(i32((uv3.x >> 28) & 3) - 2) * xa03.z
        g0 += f32(i32((gv0.x >> 30) & 3) - 2) * xa03.w
        u0 += f32(i32((uv0.x >> 30) & 3) - 2) * xa03.w
        g1 += f32(i32((gv1.x >> 30) & 3) - 2) * xa03.w
        u1 += f32(i32((uv1.x >> 30) & 3) - 2) * xa03.w
        g2 += f32(i32((gv2.x >> 30) & 3) - 2) * xa03.w
        u2 += f32(i32((uv2.x >> 30) & 3) - 2) * xa03.w
        g3 += f32(i32((gv3.x >> 30) & 3) - 2) * xa03.w
        u3 += f32(i32((uv3.x >> 30) & 3) - 2) * xa03.w
        xa10 = x[xb + 4]
        g0 += f32(i32(gv0.y & 3) - 2) * xa10.x
        u0 += f32(i32(uv0.y & 3) - 2) * xa10.x
        g1 += f32(i32(gv1.y & 3) - 2) * xa10.x
        u1 += f32(i32(uv1.y & 3) - 2) * xa10.x
        g2 += f32(i32(gv2.y & 3) - 2) * xa10.x
        u2 += f32(i32(uv2.y & 3) - 2) * xa10.x
        g3 += f32(i32(gv3.y & 3) - 2) * xa10.x
        u3 += f32(i32(uv3.y & 3) - 2) * xa10.x
        g0 += f32(i32((gv0.y >> 2) & 3) - 2) * xa10.y
        u0 += f32(i32((uv0.y >> 2) & 3) - 2) * xa10.y
        g1 += f32(i32((gv1.y >> 2) & 3) - 2) * xa10.y
        u1 += f32(i32((uv1.y >> 2) & 3) - 2) * xa10.y
        g2 += f32(i32((gv2.y >> 2) & 3) - 2) * xa10.y
        u2 += f32(i32((uv2.y >> 2) & 3) - 2) * xa10.y
        g3 += f32(i32((gv3.y >> 2) & 3) - 2) * xa10.y
        u3 += f32(i32((uv3.y >> 2) & 3) - 2) * xa10.y
        g0 += f32(i32((gv0.y >> 4) & 3) - 2) * xa10.z
        u0 += f32(i32((uv0.y >> 4) & 3) - 2) * xa10.z
        g1 += f32(i32((gv1.y >> 4) & 3) - 2) * xa10.z
        u1 += f32(i32((uv1.y >> 4) & 3) - 2) * xa10.z
        g2 += f32(i32((gv2.y >> 4) & 3) - 2) * xa10.z
        u2 += f32(i32((uv2.y >> 4) & 3) - 2) * xa10.z
        g3 += f32(i32((gv3.y >> 4) & 3) - 2) * xa10.z
        u3 += f32(i32((uv3.y >> 4) & 3) - 2) * xa10.z
        g0 += f32(i32((gv0.y >> 6) & 3) - 2) * xa10.w
        u0 += f32(i32((uv0.y >> 6) & 3) - 2) * xa10.w
        g1 += f32(i32((gv1.y >> 6) & 3) - 2) * xa10.w
        u1 += f32(i32((uv1.y >> 6) & 3) - 2) * xa10.w
        g2 += f32(i32((gv2.y >> 6) & 3) - 2) * xa10.w
        u2 += f32(i32((uv2.y >> 6) & 3) - 2) * xa10.w
        g3 += f32(i32((gv3.y >> 6) & 3) - 2) * xa10.w
        u3 += f32(i32((uv3.y >> 6) & 3) - 2) * xa10.w
        xa11 = x[xb + 5]
        g0 += f32(i32((gv0.y >> 8) & 3) - 2) * xa11.x
        u0 += f32(i32((uv0.y >> 8) & 3) - 2) * xa11.x
        g1 += f32(i32((gv1.y >> 8) & 3) - 2) * xa11.x
        u1 += f32(i32((uv1.y >> 8) & 3) - 2) * xa11.x
        g2 += f32(i32((gv2.y >> 8) & 3) - 2) * xa11.x
        u2 += f32(i32((uv2.y >> 8) & 3) - 2) * xa11.x
        g3 += f32(i32((gv3.y >> 8) & 3) - 2) * xa11.x
        u3 += f32(i32((uv3.y >> 8) & 3) - 2) * xa11.x
        g0 += f32(i32((gv0.y >> 10) & 3) - 2) * xa11.y
        u0 += f32(i32((uv0.y >> 10) & 3) - 2) * xa11.y
        g1 += f32(i32((gv1.y >> 10) & 3) - 2) * xa11.y
        u1 += f32(i32((uv1.y >> 10) & 3) - 2) * xa11.y
        g2 += f32(i32((gv2.y >> 10) & 3) - 2) * xa11.y
        u2 += f32(i32((uv2.y >> 10) & 3) - 2) * xa11.y
        g3 += f32(i32((gv3.y >> 10) & 3) - 2) * xa11.y
        u3 += f32(i32((uv3.y >> 10) & 3) - 2) * xa11.y
        g0 += f32(i32((gv0.y >> 12) & 3) - 2) * xa11.z
        u0 += f32(i32((uv0.y >> 12) & 3) - 2) * xa11.z
        g1 += f32(i32((gv1.y >> 12) & 3) - 2) * xa11.z
        u1 += f32(i32((uv1.y >> 12) & 3) - 2) * xa11.z
        g2 += f32(i32((gv2.y >> 12) & 3) - 2) * xa11.z
        u2 += f32(i32((uv2.y >> 12) & 3) - 2) * xa11.z
        g3 += f32(i32((gv3.y >> 12) & 3) - 2) * xa11.z
        u3 += f32(i32((uv3.y >> 12) & 3) - 2) * xa11.z
        g0 += f32(i32((gv0.y >> 14) & 3) - 2) * xa11.w
        u0 += f32(i32((uv0.y >> 14) & 3) - 2) * xa11.w
        g1 += f32(i32((gv1.y >> 14) & 3) - 2) * xa11.w
        u1 += f32(i32((uv1.y >> 14) & 3) - 2) * xa11.w
        g2 += f32(i32((gv2.y >> 14) & 3) - 2) * xa11.w
        u2 += f32(i32((uv2.y >> 14) & 3) - 2) * xa11.w
        g3 += f32(i32((gv3.y >> 14) & 3) - 2) * xa11.w
        u3 += f32(i32((uv3.y >> 14) & 3) - 2) * xa11.w
        xa12 = x[xb + 6]
        g0 += f32(i32((gv0.y >> 16) & 3) - 2) * xa12.x
        u0 += f32(i32((uv0.y >> 16) & 3) - 2) * xa12.x
        g1 += f32(i32((gv1.y >> 16) & 3) - 2) * xa12.x
        u1 += f32(i32((uv1.y >> 16) & 3) - 2) * xa12.x
        g2 += f32(i32((gv2.y >> 16) & 3) - 2) * xa12.x
        u2 += f32(i32((uv2.y >> 16) & 3) - 2) * xa12.x
        g3 += f32(i32((gv3.y >> 16) & 3) - 2) * xa12.x
        u3 += f32(i32((uv3.y >> 16) & 3) - 2) * xa12.x
        g0 += f32(i32((gv0.y >> 18) & 3) - 2) * xa12.y
        u0 += f32(i32((uv0.y >> 18) & 3) - 2) * xa12.y
        g1 += f32(i32((gv1.y >> 18) & 3) - 2) * xa12.y
        u1 += f32(i32((uv1.y >> 18) & 3) - 2) * xa12.y
        g2 += f32(i32((gv2.y >> 18) & 3) - 2) * xa12.y
        u2 += f32(i32((uv2.y >> 18) & 3) - 2) * xa12.y
        g3 += f32(i32((gv3.y >> 18) & 3) - 2) * xa12.y
        u3 += f32(i32((uv3.y >> 18) & 3) - 2) * xa12.y
        g0 += f32(i32((gv0.y >> 20) & 3) - 2) * xa12.z
        u0 += f32(i32((uv0.y >> 20) & 3) - 2) * xa12.z
        g1 += f32(i32((gv1.y >> 20) & 3) - 2) * xa12.z
        u1 += f32(i32((uv1.y >> 20) & 3) - 2) * xa12.z
        g2 += f32(i32((gv2.y >> 20) & 3) - 2) * xa12.z
        u2 += f32(i32((uv2.y >> 20) & 3) - 2) * xa12.z
        g3 += f32(i32((gv3.y >> 20) & 3) - 2) * xa12.z
        u3 += f32(i32((uv3.y >> 20) & 3) - 2) * xa12.z
        g0 += f32(i32((gv0.y >> 22) & 3) - 2) * xa12.w
        u0 += f32(i32((uv0.y >> 22) & 3) - 2) * xa12.w
        g1 += f32(i32((gv1.y >> 22) & 3) - 2) * xa12.w
        u1 += f32(i32((uv1.y >> 22) & 3) - 2) * xa12.w
        g2 += f32(i32((gv2.y >> 22) & 3) - 2) * xa12.w
        u2 += f32(i32((uv2.y >> 22) & 3) - 2) * xa12.w
        g3 += f32(i32((gv3.y >> 22) & 3) - 2) * xa12.w
        u3 += f32(i32((uv3.y >> 22) & 3) - 2) * xa12.w
        xa13 = x[xb + 7]
        g0 += f32(i32((gv0.y >> 24) & 3) - 2) * xa13.x
        u0 += f32(i32((uv0.y >> 24) & 3) - 2) * xa13.x
        g1 += f32(i32((gv1.y >> 24) & 3) - 2) * xa13.x
        u1 += f32(i32((uv1.y >> 24) & 3) - 2) * xa13.x
        g2 += f32(i32((gv2.y >> 24) & 3) - 2) * xa13.x
        u2 += f32(i32((uv2.y >> 24) & 3) - 2) * xa13.x
        g3 += f32(i32((gv3.y >> 24) & 3) - 2) * xa13.x
        u3 += f32(i32((uv3.y >> 24) & 3) - 2) * xa13.x
        g0 += f32(i32((gv0.y >> 26) & 3) - 2) * xa13.y
        u0 += f32(i32((uv0.y >> 26) & 3) - 2) * xa13.y
        g1 += f32(i32((gv1.y >> 26) & 3) - 2) * xa13.y
        u1 += f32(i32((uv1.y >> 26) & 3) - 2) * xa13.y
        g2 += f32(i32((gv2.y >> 26) & 3) - 2) * xa13.y
        u2 += f32(i32((uv2.y >> 26) & 3) - 2) * xa13.y
        g3 += f32(i32((gv3.y >> 26) & 3) - 2) * xa13.y
        u3 += f32(i32((uv3.y >> 26) & 3) - 2) * xa13.y
        g0 += f32(i32((gv0.y >> 28) & 3) - 2) * xa13.z
        u0 += f32(i32((uv0.y >> 28) & 3) - 2) * xa13.z
        g1 += f32(i32((gv1.y >> 28) & 3) - 2) * xa13.z
        u1 += f32(i32((uv1.y >> 28) & 3) - 2) * xa13.z
        g2 += f32(i32((gv2.y >> 28) & 3) - 2) * xa13.z
        u2 += f32(i32((uv2.y >> 28) & 3) - 2) * xa13.z
        g3 += f32(i32((gv3.y >> 28) & 3) - 2) * xa13.z
        u3 += f32(i32((uv3.y >> 28) & 3) - 2) * xa13.z
        g0 += f32(i32((gv0.y >> 30) & 3) - 2) * xa13.w
        u0 += f32(i32((uv0.y >> 30) & 3) - 2) * xa13.w
        g1 += f32(i32((gv1.y >> 30) & 3) - 2) * xa13.w
        u1 += f32(i32((uv1.y >> 30) & 3) - 2) * xa13.w
        g2 += f32(i32((gv2.y >> 30) & 3) - 2) * xa13.w
        u2 += f32(i32((uv2.y >> 30) & 3) - 2) * xa13.w
        g3 += f32(i32((gv3.y >> 30) & 3) - 2) * xa13.w
        u3 += f32(i32((uv3.y >> 30) & 3) - 2) * xa13.w
        xa20 = x[xb + 8]
        g0 += f32(i32(gv0.z & 3) - 2) * xa20.x
        u0 += f32(i32(uv0.z & 3) - 2) * xa20.x
        g1 += f32(i32(gv1.z & 3) - 2) * xa20.x
        u1 += f32(i32(uv1.z & 3) - 2) * xa20.x
        g2 += f32(i32(gv2.z & 3) - 2) * xa20.x
        u2 += f32(i32(uv2.z & 3) - 2) * xa20.x
        g3 += f32(i32(gv3.z & 3) - 2) * xa20.x
        u3 += f32(i32(uv3.z & 3) - 2) * xa20.x
        g0 += f32(i32((gv0.z >> 2) & 3) - 2) * xa20.y
        u0 += f32(i32((uv0.z >> 2) & 3) - 2) * xa20.y
        g1 += f32(i32((gv1.z >> 2) & 3) - 2) * xa20.y
        u1 += f32(i32((uv1.z >> 2) & 3) - 2) * xa20.y
        g2 += f32(i32((gv2.z >> 2) & 3) - 2) * xa20.y
        u2 += f32(i32((uv2.z >> 2) & 3) - 2) * xa20.y
        g3 += f32(i32((gv3.z >> 2) & 3) - 2) * xa20.y
        u3 += f32(i32((uv3.z >> 2) & 3) - 2) * xa20.y
        g0 += f32(i32((gv0.z >> 4) & 3) - 2) * xa20.z
        u0 += f32(i32((uv0.z >> 4) & 3) - 2) * xa20.z
        g1 += f32(i32((gv1.z >> 4) & 3) - 2) * xa20.z
        u1 += f32(i32((uv1.z >> 4) & 3) - 2) * xa20.z
        g2 += f32(i32((gv2.z >> 4) & 3) - 2) * xa20.z
        u2 += f32(i32((uv2.z >> 4) & 3) - 2) * xa20.z
        g3 += f32(i32((gv3.z >> 4) & 3) - 2) * xa20.z
        u3 += f32(i32((uv3.z >> 4) & 3) - 2) * xa20.z
        g0 += f32(i32((gv0.z >> 6) & 3) - 2) * xa20.w
        u0 += f32(i32((uv0.z >> 6) & 3) - 2) * xa20.w
        g1 += f32(i32((gv1.z >> 6) & 3) - 2) * xa20.w
        u1 += f32(i32((uv1.z >> 6) & 3) - 2) * xa20.w
        g2 += f32(i32((gv2.z >> 6) & 3) - 2) * xa20.w
        u2 += f32(i32((uv2.z >> 6) & 3) - 2) * xa20.w
        g3 += f32(i32((gv3.z >> 6) & 3) - 2) * xa20.w
        u3 += f32(i32((uv3.z >> 6) & 3) - 2) * xa20.w
        xa21 = x[xb + 9]
        g0 += f32(i32((gv0.z >> 8) & 3) - 2) * xa21.x
        u0 += f32(i32((uv0.z >> 8) & 3) - 2) * xa21.x
        g1 += f32(i32((gv1.z >> 8) & 3) - 2) * xa21.x
        u1 += f32(i32((uv1.z >> 8) & 3) - 2) * xa21.x
        g2 += f32(i32((gv2.z >> 8) & 3) - 2) * xa21.x
        u2 += f32(i32((uv2.z >> 8) & 3) - 2) * xa21.x
        g3 += f32(i32((gv3.z >> 8) & 3) - 2) * xa21.x
        u3 += f32(i32((uv3.z >> 8) & 3) - 2) * xa21.x
        g0 += f32(i32((gv0.z >> 10) & 3) - 2) * xa21.y
        u0 += f32(i32((uv0.z >> 10) & 3) - 2) * xa21.y
        g1 += f32(i32((gv1.z >> 10) & 3) - 2) * xa21.y
        u1 += f32(i32((uv1.z >> 10) & 3) - 2) * xa21.y
        g2 += f32(i32((gv2.z >> 10) & 3) - 2) * xa21.y
        u2 += f32(i32((uv2.z >> 10) & 3) - 2) * xa21.y
        g3 += f32(i32((gv3.z >> 10) & 3) - 2) * xa21.y
        u3 += f32(i32((uv3.z >> 10) & 3) - 2) * xa21.y
        g0 += f32(i32((gv0.z >> 12) & 3) - 2) * xa21.z
        u0 += f32(i32((uv0.z >> 12) & 3) - 2) * xa21.z
        g1 += f32(i32((gv1.z >> 12) & 3) - 2) * xa21.z
        u1 += f32(i32((uv1.z >> 12) & 3) - 2) * xa21.z
        g2 += f32(i32((gv2.z >> 12) & 3) - 2) * xa21.z
        u2 += f32(i32((uv2.z >> 12) & 3) - 2) * xa21.z
        g3 += f32(i32((gv3.z >> 12) & 3) - 2) * xa21.z
        u3 += f32(i32((uv3.z >> 12) & 3) - 2) * xa21.z
        g0 += f32(i32((gv0.z >> 14) & 3) - 2) * xa21.w
        u0 += f32(i32((uv0.z >> 14) & 3) - 2) * xa21.w
        g1 += f32(i32((gv1.z >> 14) & 3) - 2) * xa21.w
        u1 += f32(i32((uv1.z >> 14) & 3) - 2) * xa21.w
        g2 += f32(i32((gv2.z >> 14) & 3) - 2) * xa21.w
        u2 += f32(i32((uv2.z >> 14) & 3) - 2) * xa21.w
        g3 += f32(i32((gv3.z >> 14) & 3) - 2) * xa21.w
        u3 += f32(i32((uv3.z >> 14) & 3) - 2) * xa21.w
        xa22 = x[xb + 10]
        g0 += f32(i32((gv0.z >> 16) & 3) - 2) * xa22.x
        u0 += f32(i32((uv0.z >> 16) & 3) - 2) * xa22.x
        g1 += f32(i32((gv1.z >> 16) & 3) - 2) * xa22.x
        u1 += f32(i32((uv1.z >> 16) & 3) - 2) * xa22.x
        g2 += f32(i32((gv2.z >> 16) & 3) - 2) * xa22.x
        u2 += f32(i32((uv2.z >> 16) & 3) - 2) * xa22.x
        g3 += f32(i32((gv3.z >> 16) & 3) - 2) * xa22.x
        u3 += f32(i32((uv3.z >> 16) & 3) - 2) * xa22.x
        g0 += f32(i32((gv0.z >> 18) & 3) - 2) * xa22.y
        u0 += f32(i32((uv0.z >> 18) & 3) - 2) * xa22.y
        g1 += f32(i32((gv1.z >> 18) & 3) - 2) * xa22.y
        u1 += f32(i32((uv1.z >> 18) & 3) - 2) * xa22.y
        g2 += f32(i32((gv2.z >> 18) & 3) - 2) * xa22.y
        u2 += f32(i32((uv2.z >> 18) & 3) - 2) * xa22.y
        g3 += f32(i32((gv3.z >> 18) & 3) - 2) * xa22.y
        u3 += f32(i32((uv3.z >> 18) & 3) - 2) * xa22.y
        g0 += f32(i32((gv0.z >> 20) & 3) - 2) * xa22.z
        u0 += f32(i32((uv0.z >> 20) & 3) - 2) * xa22.z
        g1 += f32(i32((gv1.z >> 20) & 3) - 2) * xa22.z
        u1 += f32(i32((uv1.z >> 20) & 3) - 2) * xa22.z
        g2 += f32(i32((gv2.z >> 20) & 3) - 2) * xa22.z
        u2 += f32(i32((uv2.z >> 20) & 3) - 2) * xa22.z
        g3 += f32(i32((gv3.z >> 20) & 3) - 2) * xa22.z
        u3 += f32(i32((uv3.z >> 20) & 3) - 2) * xa22.z
        g0 += f32(i32((gv0.z >> 22) & 3) - 2) * xa22.w
        u0 += f32(i32((uv0.z >> 22) & 3) - 2) * xa22.w
        g1 += f32(i32((gv1.z >> 22) & 3) - 2) * xa22.w
        u1 += f32(i32((uv1.z >> 22) & 3) - 2) * xa22.w
        g2 += f32(i32((gv2.z >> 22) & 3) - 2) * xa22.w
        u2 += f32(i32((uv2.z >> 22) & 3) - 2) * xa22.w
        g3 += f32(i32((gv3.z >> 22) & 3) - 2) * xa22.w
        u3 += f32(i32((uv3.z >> 22) & 3) - 2) * xa22.w
        xa23 = x[xb + 11]
        g0 += f32(i32((gv0.z >> 24) & 3) - 2) * xa23.x
        u0 += f32(i32((uv0.z >> 24) & 3) - 2) * xa23.x
        g1 += f32(i32((gv1.z >> 24) & 3) - 2) * xa23.x
        u1 += f32(i32((uv1.z >> 24) & 3) - 2) * xa23.x
        g2 += f32(i32((gv2.z >> 24) & 3) - 2) * xa23.x
        u2 += f32(i32((uv2.z >> 24) & 3) - 2) * xa23.x
        g3 += f32(i32((gv3.z >> 24) & 3) - 2) * xa23.x
        u3 += f32(i32((uv3.z >> 24) & 3) - 2) * xa23.x
        g0 += f32(i32((gv0.z >> 26) & 3) - 2) * xa23.y
        u0 += f32(i32((uv0.z >> 26) & 3) - 2) * xa23.y
        g1 += f32(i32((gv1.z >> 26) & 3) - 2) * xa23.y
        u1 += f32(i32((uv1.z >> 26) & 3) - 2) * xa23.y
        g2 += f32(i32((gv2.z >> 26) & 3) - 2) * xa23.y
        u2 += f32(i32((uv2.z >> 26) & 3) - 2) * xa23.y
        g3 += f32(i32((gv3.z >> 26) & 3) - 2) * xa23.y
        u3 += f32(i32((uv3.z >> 26) & 3) - 2) * xa23.y
        g0 += f32(i32((gv0.z >> 28) & 3) - 2) * xa23.z
        u0 += f32(i32((uv0.z >> 28) & 3) - 2) * xa23.z
        g1 += f32(i32((gv1.z >> 28) & 3) - 2) * xa23.z
        u1 += f32(i32((uv1.z >> 28) & 3) - 2) * xa23.z
        g2 += f32(i32((gv2.z >> 28) & 3) - 2) * xa23.z
        u2 += f32(i32((uv2.z >> 28) & 3) - 2) * xa23.z
        g3 += f32(i32((gv3.z >> 28) & 3) - 2) * xa23.z
        u3 += f32(i32((uv3.z >> 28) & 3) - 2) * xa23.z
        g0 += f32(i32((gv0.z >> 30) & 3) - 2) * xa23.w
        u0 += f32(i32((uv0.z >> 30) & 3) - 2) * xa23.w
        g1 += f32(i32((gv1.z >> 30) & 3) - 2) * xa23.w
        u1 += f32(i32((uv1.z >> 30) & 3) - 2) * xa23.w
        g2 += f32(i32((gv2.z >> 30) & 3) - 2) * xa23.w
        u2 += f32(i32((uv2.z >> 30) & 3) - 2) * xa23.w
        g3 += f32(i32((gv3.z >> 30) & 3) - 2) * xa23.w
        u3 += f32(i32((uv3.z >> 30) & 3) - 2) * xa23.w
        xa30 = x[xb + 12]
        g0 += f32(i32(gv0.w & 3) - 2) * xa30.x
        u0 += f32(i32(uv0.w & 3) - 2) * xa30.x
        g1 += f32(i32(gv1.w & 3) - 2) * xa30.x
        u1 += f32(i32(uv1.w & 3) - 2) * xa30.x
        g2 += f32(i32(gv2.w & 3) - 2) * xa30.x
        u2 += f32(i32(uv2.w & 3) - 2) * xa30.x
        g3 += f32(i32(gv3.w & 3) - 2) * xa30.x
        u3 += f32(i32(uv3.w & 3) - 2) * xa30.x
        g0 += f32(i32((gv0.w >> 2) & 3) - 2) * xa30.y
        u0 += f32(i32((uv0.w >> 2) & 3) - 2) * xa30.y
        g1 += f32(i32((gv1.w >> 2) & 3) - 2) * xa30.y
        u1 += f32(i32((uv1.w >> 2) & 3) - 2) * xa30.y
        g2 += f32(i32((gv2.w >> 2) & 3) - 2) * xa30.y
        u2 += f32(i32((uv2.w >> 2) & 3) - 2) * xa30.y
        g3 += f32(i32((gv3.w >> 2) & 3) - 2) * xa30.y
        u3 += f32(i32((uv3.w >> 2) & 3) - 2) * xa30.y
        g0 += f32(i32((gv0.w >> 4) & 3) - 2) * xa30.z
        u0 += f32(i32((uv0.w >> 4) & 3) - 2) * xa30.z
        g1 += f32(i32((gv1.w >> 4) & 3) - 2) * xa30.z
        u1 += f32(i32((uv1.w >> 4) & 3) - 2) * xa30.z
        g2 += f32(i32((gv2.w >> 4) & 3) - 2) * xa30.z
        u2 += f32(i32((uv2.w >> 4) & 3) - 2) * xa30.z
        g3 += f32(i32((gv3.w >> 4) & 3) - 2) * xa30.z
        u3 += f32(i32((uv3.w >> 4) & 3) - 2) * xa30.z
        g0 += f32(i32((gv0.w >> 6) & 3) - 2) * xa30.w
        u0 += f32(i32((uv0.w >> 6) & 3) - 2) * xa30.w
        g1 += f32(i32((gv1.w >> 6) & 3) - 2) * xa30.w
        u1 += f32(i32((uv1.w >> 6) & 3) - 2) * xa30.w
        g2 += f32(i32((gv2.w >> 6) & 3) - 2) * xa30.w
        u2 += f32(i32((uv2.w >> 6) & 3) - 2) * xa30.w
        g3 += f32(i32((gv3.w >> 6) & 3) - 2) * xa30.w
        u3 += f32(i32((uv3.w >> 6) & 3) - 2) * xa30.w
        xa31 = x[xb + 13]
        g0 += f32(i32((gv0.w >> 8) & 3) - 2) * xa31.x
        u0 += f32(i32((uv0.w >> 8) & 3) - 2) * xa31.x
        g1 += f32(i32((gv1.w >> 8) & 3) - 2) * xa31.x
        u1 += f32(i32((uv1.w >> 8) & 3) - 2) * xa31.x
        g2 += f32(i32((gv2.w >> 8) & 3) - 2) * xa31.x
        u2 += f32(i32((uv2.w >> 8) & 3) - 2) * xa31.x
        g3 += f32(i32((gv3.w >> 8) & 3) - 2) * xa31.x
        u3 += f32(i32((uv3.w >> 8) & 3) - 2) * xa31.x
        g0 += f32(i32((gv0.w >> 10) & 3) - 2) * xa31.y
        u0 += f32(i32((uv0.w >> 10) & 3) - 2) * xa31.y
        g1 += f32(i32((gv1.w >> 10) & 3) - 2) * xa31.y
        u1 += f32(i32((uv1.w >> 10) & 3) - 2) * xa31.y
        g2 += f32(i32((gv2.w >> 10) & 3) - 2) * xa31.y
        u2 += f32(i32((uv2.w >> 10) & 3) - 2) * xa31.y
        g3 += f32(i32((gv3.w >> 10) & 3) - 2) * xa31.y
        u3 += f32(i32((uv3.w >> 10) & 3) - 2) * xa31.y
        g0 += f32(i32((gv0.w >> 12) & 3) - 2) * xa31.z
        u0 += f32(i32((uv0.w >> 12) & 3) - 2) * xa31.z
        g1 += f32(i32((gv1.w >> 12) & 3) - 2) * xa31.z
        u1 += f32(i32((uv1.w >> 12) & 3) - 2) * xa31.z
        g2 += f32(i32((gv2.w >> 12) & 3) - 2) * xa31.z
        u2 += f32(i32((uv2.w >> 12) & 3) - 2) * xa31.z
        g3 += f32(i32((gv3.w >> 12) & 3) - 2) * xa31.z
        u3 += f32(i32((uv3.w >> 12) & 3) - 2) * xa31.z
        g0 += f32(i32((gv0.w >> 14) & 3) - 2) * xa31.w
        u0 += f32(i32((uv0.w >> 14) & 3) - 2) * xa31.w
        g1 += f32(i32((gv1.w >> 14) & 3) - 2) * xa31.w
        u1 += f32(i32((uv1.w >> 14) & 3) - 2) * xa31.w
        g2 += f32(i32((gv2.w >> 14) & 3) - 2) * xa31.w
        u2 += f32(i32((uv2.w >> 14) & 3) - 2) * xa31.w
        g3 += f32(i32((gv3.w >> 14) & 3) - 2) * xa31.w
        u3 += f32(i32((uv3.w >> 14) & 3) - 2) * xa31.w
        xa32 = x[xb + 14]
        g0 += f32(i32((gv0.w >> 16) & 3) - 2) * xa32.x
        u0 += f32(i32((uv0.w >> 16) & 3) - 2) * xa32.x
        g1 += f32(i32((gv1.w >> 16) & 3) - 2) * xa32.x
        u1 += f32(i32((uv1.w >> 16) & 3) - 2) * xa32.x
        g2 += f32(i32((gv2.w >> 16) & 3) - 2) * xa32.x
        u2 += f32(i32((uv2.w >> 16) & 3) - 2) * xa32.x
        g3 += f32(i32((gv3.w >> 16) & 3) - 2) * xa32.x
        u3 += f32(i32((uv3.w >> 16) & 3) - 2) * xa32.x
        g0 += f32(i32((gv0.w >> 18) & 3) - 2) * xa32.y
        u0 += f32(i32((uv0.w >> 18) & 3) - 2) * xa32.y
        g1 += f32(i32((gv1.w >> 18) & 3) - 2) * xa32.y
        u1 += f32(i32((uv1.w >> 18) & 3) - 2) * xa32.y
        g2 += f32(i32((gv2.w >> 18) & 3) - 2) * xa32.y
        u2 += f32(i32((uv2.w >> 18) & 3) - 2) * xa32.y
        g3 += f32(i32((gv3.w >> 18) & 3) - 2) * xa32.y
        u3 += f32(i32((uv3.w >> 18) & 3) - 2) * xa32.y
        g0 += f32(i32((gv0.w >> 20) & 3) - 2) * xa32.z
        u0 += f32(i32((uv0.w >> 20) & 3) - 2) * xa32.z
        g1 += f32(i32((gv1.w >> 20) & 3) - 2) * xa32.z
        u1 += f32(i32((uv1.w >> 20) & 3) - 2) * xa32.z
        g2 += f32(i32((gv2.w >> 20) & 3) - 2) * xa32.z
        u2 += f32(i32((uv2.w >> 20) & 3) - 2) * xa32.z
        g3 += f32(i32((gv3.w >> 20) & 3) - 2) * xa32.z
        u3 += f32(i32((uv3.w >> 20) & 3) - 2) * xa32.z
        g0 += f32(i32((gv0.w >> 22) & 3) - 2) * xa32.w
        u0 += f32(i32((uv0.w >> 22) & 3) - 2) * xa32.w
        g1 += f32(i32((gv1.w >> 22) & 3) - 2) * xa32.w
        u1 += f32(i32((uv1.w >> 22) & 3) - 2) * xa32.w
        g2 += f32(i32((gv2.w >> 22) & 3) - 2) * xa32.w
        u2 += f32(i32((uv2.w >> 22) & 3) - 2) * xa32.w
        g3 += f32(i32((gv3.w >> 22) & 3) - 2) * xa32.w
        u3 += f32(i32((uv3.w >> 22) & 3) - 2) * xa32.w
        xa33 = x[xb + 15]
        g0 += f32(i32((gv0.w >> 24) & 3) - 2) * xa33.x
        u0 += f32(i32((uv0.w >> 24) & 3) - 2) * xa33.x
        g1 += f32(i32((gv1.w >> 24) & 3) - 2) * xa33.x
        u1 += f32(i32((uv1.w >> 24) & 3) - 2) * xa33.x
        g2 += f32(i32((gv2.w >> 24) & 3) - 2) * xa33.x
        u2 += f32(i32((uv2.w >> 24) & 3) - 2) * xa33.x
        g3 += f32(i32((gv3.w >> 24) & 3) - 2) * xa33.x
        u3 += f32(i32((uv3.w >> 24) & 3) - 2) * xa33.x
        g0 += f32(i32((gv0.w >> 26) & 3) - 2) * xa33.y
        u0 += f32(i32((uv0.w >> 26) & 3) - 2) * xa33.y
        g1 += f32(i32((gv1.w >> 26) & 3) - 2) * xa33.y
        u1 += f32(i32((uv1.w >> 26) & 3) - 2) * xa33.y
        g2 += f32(i32((gv2.w >> 26) & 3) - 2) * xa33.y
        u2 += f32(i32((uv2.w >> 26) & 3) - 2) * xa33.y
        g3 += f32(i32((gv3.w >> 26) & 3) - 2) * xa33.y
        u3 += f32(i32((uv3.w >> 26) & 3) - 2) * xa33.y
        g0 += f32(i32((gv0.w >> 28) & 3) - 2) * xa33.z
        u0 += f32(i32((uv0.w >> 28) & 3) - 2) * xa33.z
        g1 += f32(i32((gv1.w >> 28) & 3) - 2) * xa33.z
        u1 += f32(i32((uv1.w >> 28) & 3) - 2) * xa33.z
        g2 += f32(i32((gv2.w >> 28) & 3) - 2) * xa33.z
        u2 += f32(i32((uv2.w >> 28) & 3) - 2) * xa33.z
        g3 += f32(i32((gv3.w >> 28) & 3) - 2) * xa33.z
        u3 += f32(i32((uv3.w >> 28) & 3) - 2) * xa33.z
        g0 += f32(i32((gv0.w >> 30) & 3) - 2) * xa33.w
        u0 += f32(i32((uv0.w >> 30) & 3) - 2) * xa33.w
        g1 += f32(i32((gv1.w >> 30) & 3) - 2) * xa33.w
        u1 += f32(i32((uv1.w >> 30) & 3) - 2) * xa33.w
        g2 += f32(i32((gv2.w >> 30) & 3) - 2) * xa33.w
        u2 += f32(i32((uv2.w >> 30) & 3) - 2) * xa33.w
        g3 += f32(i32((gv3.w >> 30) & 3) - 2) * xa33.w
        u3 += f32(i32((uv3.w >> 30) & 3) - 2) * xa33.w
    sg0: f32 = subgroupAdd(g0)
    su0: f32 = subgroupAdd(u0)
    sg1: f32 = subgroupAdd(g1)
    su1: f32 = subgroupAdd(u1)
...
@kernel(workgroup_size=(64,))
def mv_gateup_geglu_dq2_blk8_f16(
    wid: Builtin.workgroup_id,
    lid: Builtin.local_invocation_id,
    gate_w: StorageBuffer[u32, "read"],       # [n_out, n_in/16] int2 gate
    up_w: StorageBuffer[u32, "read"],         # [n_out, n_in/16] int2 up
    ...
    for j in range(li, n16, 64):
        ...
        uw7: u32 = up_w[r7 * n16 + j]
        b: u32 = 16 * j
        g0 += f32(f16(i32(gw0 & 3) - 2) * f16(x_in[b]))
        u0 += f32(f16(i32(uw0 & 3) - 2) * f16(x_in[b]))
        g1 += f32(f16(i32(gw1 & 3) - 2) * f16(x_in[b]))
        u1 += f32(f16(i32(uw1 & 3) - 2) * f16(x_in[b]))
        g2 += f32(f16(i32(gw2 & 3) - 2) * f16(x_in[b]))
        u2 += f32(f16(i32(uw2 & 3) - 2) * f16(x_in[b]))
        g3 += f32(f16(i32(gw3 & 3) - 2) * f16(x_in[b]))
        u3 += f32(f16(i32(uw3 & 3) - 2) * f16(x_in[b]))
        g4 += f32(f16(i32(gw4 & 3) - 2) * f16(x_in[b]))
        u4 += f32(f16(i32(uw4 & 3) - 2) * f16(x_in[b]))
        g5 += f32(f16(i32(gw5 & 3) - 2) * f16(x_in[b]))
        u5 += f32(f16(i32(uw5 & 3) - 2) * f16(x_in[b]))
        g6 += f32(f16(i32(gw6 & 3) - 2) * f16(x_in[b]))
        u6 += f32(f16(i32(uw6 & 3) - 2) * f16(x_in[b]))
        g7 += f32(f16(i32(gw7 & 3) - 2) * f16(x_in[b]))
        u7 += f32(f16(i32(uw7 & 3) - 2) * f16(x_in[b]))
        g0 += f32(f16(i32((gw0 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        u0 += f32(f16(i32((uw0 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        g1 += f32(f16(i32((gw1 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        u1 += f32(f16(i32((uw1 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        g2 += f32(f16(i32((gw2 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        u2 += f32(f16(i32((uw2 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        g3 += f32(f16(i32((gw3 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        u3 += f32(f16(i32((uw3 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        g4 += f32(f16(i32((gw4 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        u4 += f32(f16(i32((uw4 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        g5 += f32(f16(i32((gw5 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        u5 += f32(f16(i32((uw5 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        g6 += f32(f16(i32((gw6 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        u6 += f32(f16(i32((uw6 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        g7 += f32(f16(i32((gw7 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        u7 += f32(f16(i32((uw7 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        g0 += f32(f16(i32((gw0 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        u0 += f32(f16(i32((uw0 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        g1 += f32(f16(i32((gw1 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        u1 += f32(f16(i32((uw1 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        g2 += f32(f16(i32((gw2 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        u2 += f32(f16(i32((uw2 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        g3 += f32(f16(i32((gw3 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        u3 += f32(f16(i32((uw3 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        g4 += f32(f16(i32((gw4 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        u4 += f32(f16(i32((uw4 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        g5 += f32(f16(i32((gw5 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        u5 += f32(f16(i32((uw5 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        g6 += f32(f16(i32((gw6 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        u6 += f32(f16(i32((uw6 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        g7 += f32(f16(i32((gw7 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        u7 += f32(f16(i32((uw7 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        g0 += f32(f16(i32((gw0 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        u0 += f32(f16(i32((uw0 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        g1 += f32(f16(i32((gw1 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        u1 += f32(f16(i32((uw1 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        g2 += f32(f16(i32((gw2 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        u2 += f32(f16(i32((uw2 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        g3 += f32(f16(i32((gw3 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        u3 += f32(f16(i32((uw3 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        g4 += f32(f16(i32((gw4 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        u4 += f32(f16(i32((uw4 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        g5 += f32(f16(i32((gw5 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        u5 += f32(f16(i32((uw5 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        g6 += f32(f16(i32((gw6 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        u6 += f32(f16(i32((uw6 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        g7 += f32(f16(i32((gw7 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        u7 += f32(f16(i32((uw7 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        g0 += f32(f16(i32((gw0 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        u0 += f32(f16(i32((uw0 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        g1 += f32(f16(i32((gw1 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        u1 += f32(f16(i32((uw1 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        g2 += f32(f16(i32((gw2 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        u2 += f32(f16(i32((uw2 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        g3 += f32(f16(i32((gw3 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        u3 += f32(f16(i32((uw3 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        g4 += f32(f16(i32((gw4 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        u4 += f32(f16(i32((uw4 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        g5 += f32(f16(i32((gw5 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        u5 += f32(f16(i32((uw5 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        g6 += f32(f16(i32((gw6 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        u6 += f32(f16(i32((uw6 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        g7 += f32(f16(i32((gw7 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        u7 += f32(f16(i32((uw7 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        g0 += f32(f16(i32((gw0 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        u0 += f32(f16(i32((uw0 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        g1 += f32(f16(i32((gw1 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        u1 += f32(f16(i32((uw1 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        g2 += f32(f16(i32((gw2 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        u2 += f32(f16(i32((uw2 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        g3 += f32(f16(i32((gw3 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        u3 += f32(f16(i32((uw3 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        g4 += f32(f16(i32((gw4 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        u4 += f32(f16(i32((uw4 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        g5 += f32(f16(i32((gw5 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        u5 += f32(f16(i32((uw5 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        g6 += f32(f16(i32((gw6 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        u6 += f32(f16(i32((uw6 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        g7 += f32(f16(i32((gw7 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        u7 += f32(f16(i32((uw7 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        g0 += f32(f16(i32((gw0 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        u0 += f32(f16(i32((uw0 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        g1 += f32(f16(i32((gw1 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        u1 += f32(f16(i32((uw1 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        g2 += f32(f16(i32((gw2 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        u2 += f32(f16(i32((uw2 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        g3 += f32(f16(i32((gw3 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        u3 += f32(f16(i32((uw3 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        g4 += f32(f16(i32((gw4 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        u4 += f32(f16(i32((uw4 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        g5 += f32(f16(i32((gw5 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        u5 += f32(f16(i32((uw5 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        g6 += f32(f16(i32((gw6 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        u6 += f32(f16(i32((uw6 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        g7 += f32(f16(i32((gw7 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        u7 += f32(f16(i32((uw7 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        g0 += f32(f16(i32((gw0 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        u0 += f32(f16(i32((uw0 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        g1 += f32(f16(i32((gw1 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        u1 += f32(f16(i32((uw1 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        g2 += f32(f16(i32((gw2 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        u2 += f32(f16(i32((uw2 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        g3 += f32(f16(i32((gw3 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        u3 += f32(f16(i32((uw3 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        g4 += f32(f16(i32((gw4 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        u4 += f32(f16(i32((uw4 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        g5 += f32(f16(i32((gw5 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        u5 += f32(f16(i32((uw5 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        g6 += f32(f16(i32((gw6 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        u6 += f32(f16(i32((uw6 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        g7 += f32(f16(i32((gw7 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        u7 += f32(f16(i32((uw7 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        g0 += f32(f16(i32((gw0 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        u0 += f32(f16(i32((uw0 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        g1 += f32(f16(i32((gw1 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        u1 += f32(f16(i32((uw1 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        g2 += f32(f16(i32((gw2 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        u2 += f32(f16(i32((uw2 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        g3 += f32(f16(i32((gw3 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        u3 += f32(f16(i32((uw3 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        g4 += f32(f16(i32((gw4 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        u4 += f32(f16(i32((uw4 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        g5 += f32(f16(i32((gw5 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        u5 += f32(f16(i32((uw5 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        g6 += f32(f16(i32((gw6 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        u6 += f32(f16(i32((uw6 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        g7 += f32(f16(i32((gw7 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        u7 += f32(f16(i32((uw7 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        g0 += f32(f16(i32((gw0 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        u0 += f32(f16(i32((uw0 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        g1 += f32(f16(i32((gw1 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        u1 += f32(f16(i32((uw1 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        g2 += f32(f16(i32((gw2 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        u2 += f32(f16(i32((uw2 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        g3 += f32(f16(i32((gw3 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        u3 += f32(f16(i32((uw3 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        g4 += f32(f16(i32((gw4 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        u4 += f32(f16(i32((uw4 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        g5 += f32(f16(i32((gw5 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        u5 += f32(f16(i32((uw5 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        g6 += f32(f16(i32((gw6 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        u6 += f32(f16(i32((uw6 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        g7 += f32(f16(i32((gw7 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        u7 += f32(f16(i32((uw7 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        g0 += f32(f16(i32((gw0 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        u0 += f32(f16(i32((uw0 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        g1 += f32(f16(i32((gw1 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        u1 += f32(f16(i32((uw1 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        g2 += f32(f16(i32((gw2 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        u2 += f32(f16(i32((uw2 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        g3 += f32(f16(i32((gw3 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        u3 += f32(f16(i32((uw3 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        g4 += f32(f16(i32((gw4 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        u4 += f32(f16(i32((uw4 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        g5 += f32(f16(i32((gw5 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        u5 += f32(f16(i32((uw5 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        g6 += f32(f16(i32((gw6 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        u6 += f32(f16(i32((uw6 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        g7 += f32(f16(i32((gw7 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        u7 += f32(f16(i32((uw7 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        g0 += f32(f16(i32((gw0 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        u0 += f32(f16(i32((uw0 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        g1 += f32(f16(i32((gw1 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        u1 += f32(f16(i32((uw1 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        g2 += f32(f16(i32((gw2 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        u2 += f32(f16(i32((uw2 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        g3 += f32(f16(i32((gw3 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        u3 += f32(f16(i32((uw3 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        g4 += f32(f16(i32((gw4 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        u4 += f32(f16(i32((uw4 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        g5 += f32(f16(i32((gw5 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        u5 += f32(f16(i32((uw5 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        g6 += f32(f16(i32((gw6 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        u6 += f32(f16(i32((uw6 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        g7 += f32(f16(i32((gw7 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        u7 += f32(f16(i32((uw7 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        g0 += f32(f16(i32((gw0 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        u0 += f32(f16(i32((uw0 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        g1 += f32(f16(i32((gw1 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        u1 += f32(f16(i32((uw1 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        g2 += f32(f16(i32((gw2 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        u2 += f32(f16(i32((uw2 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        g3 += f32(f16(i32((gw3 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        u3 += f32(f16(i32((uw3 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        g4 += f32(f16(i32((gw4 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        u4 += f32(f16(i32((uw4 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        g5 += f32(f16(i32((gw5 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        u5 += f32(f16(i32((uw5 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        g6 += f32(f16(i32((gw6 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        u6 += f32(f16(i32((uw6 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        g7 += f32(f16(i32((gw7 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        u7 += f32(f16(i32((uw7 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        g0 += f32(f16(i32((gw0 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        u0 += f32(f16(i32((uw0 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        g1 += f32(f16(i32((gw1 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        u1 += f32(f16(i32((uw1 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        g2 += f32(f16(i32((gw2 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        u2 += f32(f16(i32((uw2 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        g3 += f32(f16(i32((gw3 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        u3 += f32(f16(i32((uw3 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        g4 += f32(f16(i32((gw4 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        u4 += f32(f16(i32((uw4 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        g5 += f32(f16(i32((gw5 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        u5 += f32(f16(i32((uw5 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        g6 += f32(f16(i32((gw6 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        u6 += f32(f16(i32((uw6 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        g7 += f32(f16(i32((gw7 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        u7 += f32(f16(i32((uw7 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        g0 += f32(f16(i32((gw0 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        u0 += f32(f16(i32((uw0 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        g1 += f32(f16(i32((gw1 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        u1 += f32(f16(i32((uw1 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        g2 += f32(f16(i32((gw2 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        u2 += f32(f16(i32((uw2 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        g3 += f32(f16(i32((gw3 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        u3 += f32(f16(i32((uw3 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        g4 += f32(f16(i32((gw4 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        u4 += f32(f16(i32((uw4 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        g5 += f32(f16(i32((gw5 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        u5 += f32(f16(i32((uw5 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        g6 += f32(f16(i32((gw6 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        u6 += f32(f16(i32((uw6 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        g7 += f32(f16(i32((gw7 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        u7 += f32(f16(i32((uw7 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        g0 += f32(f16(i32((gw0 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        u0 += f32(f16(i32((uw0 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        g1 += f32(f16(i32((gw1 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        u1 += f32(f16(i32((uw1 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        g2 += f32(f16(i32((gw2 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        u2 += f32(f16(i32((uw2 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        g3 += f32(f16(i32((gw3 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        u3 += f32(f16(i32((uw3 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        g4 += f32(f16(i32((gw4 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        u4 += f32(f16(i32((uw4 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        g5 += f32(f16(i32((gw5 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        u5 += f32(f16(i32((uw5 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        g6 += f32(f16(i32((gw6 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        u6 += f32(f16(i32((uw6 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        g7 += f32(f16(i32((gw7 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        u7 += f32(f16(i32((uw7 >> 30) & 3) - 2) * f16(x_in[b + 15]))
    pg0[li] = g0
    pu0[li] = u0
    pg1[li] = g1
    pu1[li] = u1
...
def matvec_dq4_blk2_f16(
    ...
    for j in range(li, n8, 64):
        ...
        p1: u32 = w_packed[r1 * n8 + j]
        b: u32 = 8 * j
        a0 += f32(f16(i32(p0 & 15) - 8) * f16(x_in[b]))
        a1 += f32(f16(i32(p1 & 15) - 8) * f16(x_in[b]))
        a0 += f32(f16(i32((p0 >> 4) & 15) - 8) * f16(x_in[b + 1]))
        a1 += f32(f16(i32((p1 >> 4) & 15) - 8) * f16(x_in[b + 1]))
        a0 += f32(f16(i32((p0 >> 8) & 15) - 8) * f16(x_in[b + 2]))
        a1 += f32(f16(i32((p1 >> 8) & 15) - 8) * f16(x_in[b + 2]))
        a0 += f32(f16(i32((p0 >> 12) & 15) - 8) * f16(x_in[b + 3]))
        a1 += f32(f16(i32((p1 >> 12) & 15) - 8) * f16(x_in[b + 3]))
        a0 += f32(f16(i32((p0 >> 16) & 15) - 8) * f16(x_in[b + 4]))
        a1 += f32(f16(i32((p1 >> 16) & 15) - 8) * f16(x_in[b + 4]))
        a0 += f32(f16(i32((p0 >> 20) & 15) - 8) * f16(x_in[b + 5]))
        a1 += f32(f16(i32((p1 >> 20) & 15) - 8) * f16(x_in[b + 5]))
        a0 += f32(f16(i32((p0 >> 24) & 15) - 8) * f16(x_in[b + 6]))
        a1 += f32(f16(i32((p1 >> 24) & 15) - 8) * f16(x_in[b + 6]))
        a0 += f32(f16(i32((p0 >> 28) & 15) - 8) * f16(x_in[b + 7]))
        a1 += f32(f16(i32((p1 >> 28) & 15) - 8) * f16(x_in[b + 7]))
    q0[li] = a0
    q1[li] = a1
    barrier()
    s: u32 = 32
...
def matvec_dq2_blk16_f16(
    ...
    for j in range(li, n16, 64):
        ...
        p15: u32 = w_packed[r15 * n16 + j]
        b: u32 = 16 * j
        a0 += f32(f16(i32(p0 & 3) - 2) * f16(x_in[b]))
        a1 += f32(f16(i32(p1 & 3) - 2) * f16(x_in[b]))
        a2 += f32(f16(i32(p2 & 3) - 2) * f16(x_in[b]))
        a3 += f32(f16(i32(p3 & 3) - 2) * f16(x_in[b]))
        a4 += f32(f16(i32(p4 & 3) - 2) * f16(x_in[b]))
        a5 += f32(f16(i32(p5 & 3) - 2) * f16(x_in[b]))
        a6 += f32(f16(i32(p6 & 3) - 2) * f16(x_in[b]))
        a7 += f32(f16(i32(p7 & 3) - 2) * f16(x_in[b]))
        a8 += f32(f16(i32(p8 & 3) - 2) * f16(x_in[b]))
        a9 += f32(f16(i32(p9 & 3) - 2) * f16(x_in[b]))
        a10 += f32(f16(i32(p10 & 3) - 2) * f16(x_in[b]))
        a11 += f32(f16(i32(p11 & 3) - 2) * f16(x_in[b]))
        a12 += f32(f16(i32(p12 & 3) - 2) * f16(x_in[b]))
        a13 += f32(f16(i32(p13 & 3) - 2) * f16(x_in[b]))
        a14 += f32(f16(i32(p14 & 3) - 2) * f16(x_in[b]))
        a15 += f32(f16(i32(p15 & 3) - 2) * f16(x_in[b]))
        a0 += f32(f16(i32((p0 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a1 += f32(f16(i32((p1 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a2 += f32(f16(i32((p2 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a3 += f32(f16(i32((p3 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a4 += f32(f16(i32((p4 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a5 += f32(f16(i32((p5 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a6 += f32(f16(i32((p6 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a7 += f32(f16(i32((p7 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a8 += f32(f16(i32((p8 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a9 += f32(f16(i32((p9 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a10 += f32(f16(i32((p10 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a11 += f32(f16(i32((p11 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a12 += f32(f16(i32((p12 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a13 += f32(f16(i32((p13 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a14 += f32(f16(i32((p14 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a15 += f32(f16(i32((p15 >> 2) & 3) - 2) * f16(x_in[b + 1]))
        a0 += f32(f16(i32((p0 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a1 += f32(f16(i32((p1 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a2 += f32(f16(i32((p2 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a3 += f32(f16(i32((p3 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a4 += f32(f16(i32((p4 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a5 += f32(f16(i32((p5 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a6 += f32(f16(i32((p6 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a7 += f32(f16(i32((p7 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a8 += f32(f16(i32((p8 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a9 += f32(f16(i32((p9 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a10 += f32(f16(i32((p10 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a11 += f32(f16(i32((p11 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a12 += f32(f16(i32((p12 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a13 += f32(f16(i32((p13 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a14 += f32(f16(i32((p14 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a15 += f32(f16(i32((p15 >> 4) & 3) - 2) * f16(x_in[b + 2]))
        a0 += f32(f16(i32((p0 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a1 += f32(f16(i32((p1 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a2 += f32(f16(i32((p2 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a3 += f32(f16(i32((p3 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a4 += f32(f16(i32((p4 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a5 += f32(f16(i32((p5 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a6 += f32(f16(i32((p6 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a7 += f32(f16(i32((p7 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a8 += f32(f16(i32((p8 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a9 += f32(f16(i32((p9 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a10 += f32(f16(i32((p10 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a11 += f32(f16(i32((p11 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a12 += f32(f16(i32((p12 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a13 += f32(f16(i32((p13 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a14 += f32(f16(i32((p14 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a15 += f32(f16(i32((p15 >> 6) & 3) - 2) * f16(x_in[b + 3]))
        a0 += f32(f16(i32((p0 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a1 += f32(f16(i32((p1 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a2 += f32(f16(i32((p2 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a3 += f32(f16(i32((p3 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a4 += f32(f16(i32((p4 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a5 += f32(f16(i32((p5 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a6 += f32(f16(i32((p6 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a7 += f32(f16(i32((p7 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a8 += f32(f16(i32((p8 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a9 += f32(f16(i32((p9 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a10 += f32(f16(i32((p10 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a11 += f32(f16(i32((p11 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a12 += f32(f16(i32((p12 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a13 += f32(f16(i32((p13 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a14 += f32(f16(i32((p14 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a15 += f32(f16(i32((p15 >> 8) & 3) - 2) * f16(x_in[b + 4]))
        a0 += f32(f16(i32((p0 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a1 += f32(f16(i32((p1 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a2 += f32(f16(i32((p2 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a3 += f32(f16(i32((p3 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a4 += f32(f16(i32((p4 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a5 += f32(f16(i32((p5 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a6 += f32(f16(i32((p6 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a7 += f32(f16(i32((p7 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a8 += f32(f16(i32((p8 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a9 += f32(f16(i32((p9 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a10 += f32(f16(i32((p10 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a11 += f32(f16(i32((p11 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a12 += f32(f16(i32((p12 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a13 += f32(f16(i32((p13 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a14 += f32(f16(i32((p14 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a15 += f32(f16(i32((p15 >> 10) & 3) - 2) * f16(x_in[b + 5]))
        a0 += f32(f16(i32((p0 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a1 += f32(f16(i32((p1 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a2 += f32(f16(i32((p2 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a3 += f32(f16(i32((p3 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a4 += f32(f16(i32((p4 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a5 += f32(f16(i32((p5 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a6 += f32(f16(i32((p6 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a7 += f32(f16(i32((p7 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a8 += f32(f16(i32((p8 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a9 += f32(f16(i32((p9 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a10 += f32(f16(i32((p10 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a11 += f32(f16(i32((p11 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a12 += f32(f16(i32((p12 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a13 += f32(f16(i32((p13 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a14 += f32(f16(i32((p14 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a15 += f32(f16(i32((p15 >> 12) & 3) - 2) * f16(x_in[b + 6]))
        a0 += f32(f16(i32((p0 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a1 += f32(f16(i32((p1 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a2 += f32(f16(i32((p2 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a3 += f32(f16(i32((p3 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a4 += f32(f16(i32((p4 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a5 += f32(f16(i32((p5 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a6 += f32(f16(i32((p6 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a7 += f32(f16(i32((p7 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a8 += f32(f16(i32((p8 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a9 += f32(f16(i32((p9 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a10 += f32(f16(i32((p10 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a11 += f32(f16(i32((p11 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a12 += f32(f16(i32((p12 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a13 += f32(f16(i32((p13 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a14 += f32(f16(i32((p14 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a15 += f32(f16(i32((p15 >> 14) & 3) - 2) * f16(x_in[b + 7]))
        a0 += f32(f16(i32((p0 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a1 += f32(f16(i32((p1 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a2 += f32(f16(i32((p2 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a3 += f32(f16(i32((p3 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a4 += f32(f16(i32((p4 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a5 += f32(f16(i32((p5 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a6 += f32(f16(i32((p6 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a7 += f32(f16(i32((p7 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a8 += f32(f16(i32((p8 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a9 += f32(f16(i32((p9 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a10 += f32(f16(i32((p10 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a11 += f32(f16(i32((p11 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a12 += f32(f16(i32((p12 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a13 += f32(f16(i32((p13 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a14 += f32(f16(i32((p14 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a15 += f32(f16(i32((p15 >> 16) & 3) - 2) * f16(x_in[b + 8]))
        a0 += f32(f16(i32((p0 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a1 += f32(f16(i32((p1 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a2 += f32(f16(i32((p2 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a3 += f32(f16(i32((p3 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a4 += f32(f16(i32((p4 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a5 += f32(f16(i32((p5 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a6 += f32(f16(i32((p6 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a7 += f32(f16(i32((p7 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a8 += f32(f16(i32((p8 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a9 += f32(f16(i32((p9 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a10 += f32(f16(i32((p10 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a11 += f32(f16(i32((p11 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a12 += f32(f16(i32((p12 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a13 += f32(f16(i32((p13 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a14 += f32(f16(i32((p14 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a15 += f32(f16(i32((p15 >> 18) & 3) - 2) * f16(x_in[b + 9]))
        a0 += f32(f16(i32((p0 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a1 += f32(f16(i32((p1 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a2 += f32(f16(i32((p2 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a3 += f32(f16(i32((p3 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a4 += f32(f16(i32((p4 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a5 += f32(f16(i32((p5 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a6 += f32(f16(i32((p6 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a7 += f32(f16(i32((p7 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a8 += f32(f16(i32((p8 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a9 += f32(f16(i32((p9 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a10 += f32(f16(i32((p10 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a11 += f32(f16(i32((p11 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a12 += f32(f16(i32((p12 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a13 += f32(f16(i32((p13 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a14 += f32(f16(i32((p14 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a15 += f32(f16(i32((p15 >> 20) & 3) - 2) * f16(x_in[b + 10]))
        a0 += f32(f16(i32((p0 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a1 += f32(f16(i32((p1 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a2 += f32(f16(i32((p2 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a3 += f32(f16(i32((p3 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a4 += f32(f16(i32((p4 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a5 += f32(f16(i32((p5 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a6 += f32(f16(i32((p6 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a7 += f32(f16(i32((p7 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a8 += f32(f16(i32((p8 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a9 += f32(f16(i32((p9 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a10 += f32(f16(i32((p10 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a11 += f32(f16(i32((p11 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a12 += f32(f16(i32((p12 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a13 += f32(f16(i32((p13 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a14 += f32(f16(i32((p14 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a15 += f32(f16(i32((p15 >> 22) & 3) - 2) * f16(x_in[b + 11]))
        a0 += f32(f16(i32((p0 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a1 += f32(f16(i32((p1 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a2 += f32(f16(i32((p2 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a3 += f32(f16(i32((p3 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a4 += f32(f16(i32((p4 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a5 += f32(f16(i32((p5 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a6 += f32(f16(i32((p6 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a7 += f32(f16(i32((p7 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a8 += f32(f16(i32((p8 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a9 += f32(f16(i32((p9 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a10 += f32(f16(i32((p10 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a11 += f32(f16(i32((p11 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a12 += f32(f16(i32((p12 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a13 += f32(f16(i32((p13 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a14 += f32(f16(i32((p14 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a15 += f32(f16(i32((p15 >> 24) & 3) - 2) * f16(x_in[b + 12]))
        a0 += f32(f16(i32((p0 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a1 += f32(f16(i32((p1 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a2 += f32(f16(i32((p2 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a3 += f32(f16(i32((p3 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a4 += f32(f16(i32((p4 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a5 += f32(f16(i32((p5 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a6 += f32(f16(i32((p6 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a7 += f32(f16(i32((p7 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a8 += f32(f16(i32((p8 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a9 += f32(f16(i32((p9 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a10 += f32(f16(i32((p10 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a11 += f32(f16(i32((p11 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a12 += f32(f16(i32((p12 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a13 += f32(f16(i32((p13 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a14 += f32(f16(i32((p14 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a15 += f32(f16(i32((p15 >> 26) & 3) - 2) * f16(x_in[b + 13]))
        a0 += f32(f16(i32((p0 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a1 += f32(f16(i32((p1 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a2 += f32(f16(i32((p2 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a3 += f32(f16(i32((p3 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a4 += f32(f16(i32((p4 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a5 += f32(f16(i32((p5 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a6 += f32(f16(i32((p6 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a7 += f32(f16(i32((p7 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a8 += f32(f16(i32((p8 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a9 += f32(f16(i32((p9 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a10 += f32(f16(i32((p10 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a11 += f32(f16(i32((p11 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a12 += f32(f16(i32((p12 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a13 += f32(f16(i32((p13 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a14 += f32(f16(i32((p14 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a15 += f32(f16(i32((p15 >> 28) & 3) - 2) * f16(x_in[b + 14]))
        a0 += f32(f16(i32((p0 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a1 += f32(f16(i32((p1 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a2 += f32(f16(i32((p2 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a3 += f32(f16(i32((p3 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a4 += f32(f16(i32((p4 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a5 += f32(f16(i32((p5 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a6 += f32(f16(i32((p6 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a7 += f32(f16(i32((p7 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a8 += f32(f16(i32((p8 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a9 += f32(f16(i32((p9 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a10 += f32(f16(i32((p10 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a11 += f32(f16(i32((p11 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a12 += f32(f16(i32((p12 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a13 += f32(f16(i32((p13 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a14 += f32(f16(i32((p14 >> 30) & 3) - 2) * f16(x_in[b + 15]))
        a15 += f32(f16(i32((p15 >> 30) & 3) - 2) * f16(x_in[b + 15]))
    q0[li] = a0
    q1[li] = a1
    q2[li] = a2
    q3[li] = a3
...
BROWSER_EXTRA_KERNELS.update({
    "matvec_dq4_blk2_f16": matvec_dq4_blk2_f16,
    "matvec_dq2_blk16_f16": matvec_dq2_blk16_f16,
    "mv_gateup_geglu_dq2_blk8_f16": mv_gateup_geglu_dq2_blk8_f16,
    "mv_gateup_geglu_dq2_combo4": mv_gateup_geglu_dq2_combo4,
    "matvec_dq4_vec4": matvec_dq4_vec4,
    "mv_gateup_geglu_dq2_vec4_blk2": mv_gateup_geglu_dq2_vec4_blk2,
