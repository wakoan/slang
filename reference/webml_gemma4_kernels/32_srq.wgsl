...
const M: u32 = 32u;
const M_TILE: u32 = 8u;
const IN_FEATURES: u32 = 12288u;
const OUT_FEATURES: u32 = 1536u;
const BITS: u32 = 2u;
const VALS_PER_WORD: u32 = 16u;
const CHUNKS: u32 = 4u;
...
fn main(@builtin(workgroup_id) wg: vec3<u32>, @builtin(local_invocation_id) lid: vec3<u32>) {
  ...
  loop {
    ...
    let e00 = vec4<f32>(unpack4xU8(packed0 & 0x03030303u));
    let e10 = vec4<f32>(unpack4xU8((packed0 >> 2u) & 0x03030303u));
    let e20 = vec4<f32>(unpack4xU8((packed0 >> 4u) & 0x03030303u));
    let e30 = vec4<f32>(unpack4xU8((packed0 >> 6u) & 0x03030303u));
    let q0_0 = vec4<f32>(e00.x, e10.x, e20.x, e30.x);
    let q0_1 = vec4<f32>(e00.y, e10.y, e20.y, e30.y);
    let q0_2 = vec4<f32>(e00.z, e10.z, e20.z, e30.z);
    let q0_3 = vec4<f32>(e00.w, e10.w, e20.w, e30.w);
    var packed1: u32 = 0u;
    if (rowBase + 1u < OUT_FEATURES) { packed1 = bits_buf[(rowBase + 1u) * WORDS_PER_ROW + w]; }
    let e01 = vec4<f32>(unpack4xU8(packed1 & 0x03030303u));
    let e11 = vec4<f32>(unpack4xU8((packed1 >> 2u) & 0x03030303u));
    let e21 = vec4<f32>(unpack4xU8((packed1 >> 4u) & 0x03030303u));
    let e31 = vec4<f32>(unpack4xU8((packed1 >> 6u) & 0x03030303u));
    let q1_0 = vec4<f32>(e01.x, e11.x, e21.x, e31.x);
    let q1_1 = vec4<f32>(e01.y, e11.y, e21.y, e31.y);
    let q1_2 = vec4<f32>(e01.z, e11.z, e21.z, e31.z);
    let q1_3 = vec4<f32>(e01.w, e11.w, e21.w, e31.w);
    if (mOk0) {
      ...
      let a0_2 = srq4(vec4<f32>(a[aV4Base0 + 2u]), inScale);
      sumA_0 = sumA_0 + a0_2.x + a0_2.y + a0_2.z + a0_2.w;
      sumQA_0_0 = sumQA_0_0 + dot(q0_2, a0_2);
      sumQA_0_1 = sumQA_0_1 + dot(q1_2, a0_2);
      let a0_3 = srq4(vec4<f32>(a[aV4Base0 + 3u]), inScale);
      sumA_0 = sumA_0 + a0_3.x + a0_3.y + a0_3.z + a0_3.w;
      sumQA_0_0 = sumQA_0_0 + dot(q0_3, a0_3);
      sumQA_0_1 = sumQA_0_1 + dot(q1_3, a0_3);
    }
    if (mOk1) {
      ...
      let a1_2 = srq4(vec4<f32>(a[aV4Base1 + 2u]), inScale);
      sumA_1 = sumA_1 + a1_2.x + a1_2.y + a1_2.z + a1_2.w;
      sumQA_1_0 = sumQA_1_0 + dot(q0_2, a1_2);
      sumQA_1_1 = sumQA_1_1 + dot(q1_2, a1_2);
      let a1_3 = srq4(vec4<f32>(a[aV4Base1 + 3u]), inScale);
      sumA_1 = sumA_1 + a1_3.x + a1_3.y + a1_3.z + a1_3.w;
      sumQA_1_0 = sumQA_1_0 + dot(q0_3, a1_3);
      sumQA_1_1 = sumQA_1_1 + dot(q1_3, a1_3);
    }
    if (mOk2) {
      ...
      let a2_2 = srq4(vec4<f32>(a[aV4Base2 + 2u]), inScale);
      sumA_2 = sumA_2 + a2_2.x + a2_2.y + a2_2.z + a2_2.w;
      sumQA_2_0 = sumQA_2_0 + dot(q0_2, a2_2);
      sumQA_2_1 = sumQA_2_1 + dot(q1_2, a2_2);
      let a2_3 = srq4(vec4<f32>(a[aV4Base2 + 3u]), inScale);
      sumA_2 = sumA_2 + a2_3.x + a2_3.y + a2_3.z + a2_3.w;
      sumQA_2_0 = sumQA_2_0 + dot(q0_3, a2_3);
      sumQA_2_1 = sumQA_2_1 + dot(q1_3, a2_3);
    }
    if (mOk3) {
      ...
      let a3_2 = srq4(vec4<f32>(a[aV4Base3 + 2u]), inScale);
      sumA_3 = sumA_3 + a3_2.x + a3_2.y + a3_2.z + a3_2.w;
      sumQA_3_0 = sumQA_3_0 + dot(q0_2, a3_2);
      sumQA_3_1 = sumQA_3_1 + dot(q1_2, a3_2);
      let a3_3 = srq4(vec4<f32>(a[aV4Base3 + 3u]), inScale);
      sumA_3 = sumA_3 + a3_3.x + a3_3.y + a3_3.z + a3_3.w;
      sumQA_3_0 = sumQA_3_0 + dot(q0_3, a3_3);
      sumQA_3_1 = sumQA_3_1 + dot(q1_3, a3_3);
    }
    if (mOk4) {
      ...
      let a4_2 = srq4(vec4<f32>(a[aV4Base4 + 2u]), inScale);
      sumA_4 = sumA_4 + a4_2.x + a4_2.y + a4_2.z + a4_2.w;
      sumQA_4_0 = sumQA_4_0 + dot(q0_2, a4_2);
      sumQA_4_1 = sumQA_4_1 + dot(q1_2, a4_2);
      let a4_3 = srq4(vec4<f32>(a[aV4Base4 + 3u]), inScale);
      sumA_4 = sumA_4 + a4_3.x + a4_3.y + a4_3.z + a4_3.w;
      sumQA_4_0 = sumQA_4_0 + dot(q0_3, a4_3);
      sumQA_4_1 = sumQA_4_1 + dot(q1_3, a4_3);
    }
    if (mOk5) {
      ...
      let a5_2 = srq4(vec4<f32>(a[aV4Base5 + 2u]), inScale);
      sumA_5 = sumA_5 + a5_2.x + a5_2.y + a5_2.z + a5_2.w;
      sumQA_5_0 = sumQA_5_0 + dot(q0_2, a5_2);
      sumQA_5_1 = sumQA_5_1 + dot(q1_2, a5_2);
      let a5_3 = srq4(vec4<f32>(a[aV4Base5 + 3u]), inScale);
      sumA_5 = sumA_5 + a5_3.x + a5_3.y + a5_3.z + a5_3.w;
      sumQA_5_0 = sumQA_5_0 + dot(q0_3, a5_3);
      sumQA_5_1 = sumQA_5_1 + dot(q1_3, a5_3);
    }
    if (mOk6) {
      ...
      let a6_2 = srq4(vec4<f32>(a[aV4Base6 + 2u]), inScale);
      sumA_6 = sumA_6 + a6_2.x + a6_2.y + a6_2.z + a6_2.w;
      sumQA_6_0 = sumQA_6_0 + dot(q0_2, a6_2);
      sumQA_6_1 = sumQA_6_1 + dot(q1_2, a6_2);
      let a6_3 = srq4(vec4<f32>(a[aV4Base6 + 3u]), inScale);
      sumA_6 = sumA_6 + a6_3.x + a6_3.y + a6_3.z + a6_3.w;
      sumQA_6_0 = sumQA_6_0 + dot(q0_3, a6_3);
      sumQA_6_1 = sumQA_6_1 + dot(q1_3, a6_3);
    }
    if (mOk7) {
      ...
      let a7_2 = srq4(vec4<f32>(a[aV4Base7 + 2u]), inScale);
      sumA_7 = sumA_7 + a7_2.x + a7_2.y + a7_2.z + a7_2.w;
      sumQA_7_0 = sumQA_7_0 + dot(q0_2, a7_2);
      sumQA_7_1 = sumQA_7_1 + dot(q1_2, a7_2);
      let a7_3 = srq4(vec4<f32>(a[aV4Base7 + 3u]), inScale);
      sumA_7 = sumA_7 + a7_3.x + a7_3.y + a7_3.z + a7_3.w;
      sumQA_7_0 = sumQA_7_0 + dot(q0_3, a7_3);
      sumQA_7_1 = sumQA_7_1 + dot(q1_3, a7_3);
    }
    w = w + WG;
  }
